            ...
            if ($confirmeconnexioneleve != null) {
                ...
                if (($request->login == $confirmeconnexioneleve->login && Hash::check($request->password, $confirmeconnexioneleve->passwordEleve))) {
                    ...
                    $elevenote = DB::table('Eleves')
                        ...
                        ->join('Matieres', 'Matieres.idMatiere', '=', 'Classe_')
                        ->select('Eleves.*', 'Notes.*', 'Classes.*')
                        ->where([
                        ...
                        ->first();
                    dd($elevenote);
                    return view('Eleve.accueil', compact('eleve', 'prof', 'parent', 'classe', 'et', 'matiere', 'confirmeconnexioneleve', 'elevenote'));
