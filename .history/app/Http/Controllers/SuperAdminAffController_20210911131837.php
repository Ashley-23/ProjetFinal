...
class SuperAdminAffController extends Controller
{
    ...
    public function updateeleveaff($idEleve)
    {
        ...
        $classe = Classe::all();
        $nomClasse = DB::table('Classe')
            ->join('Eleve', 'Classe.idClasse', '=', 'Eleve.idClasse')
            ->select('Classe.nomClasse', 'Classe.typeClasse', 'orders.price')
            ->get();
        ...
        return view('Superadmin.Eleve.updateeleve', compact('eleveedit', 'eleve', 'classe', 'nomClasse'));
    }
