    ...
    public function connexion(Request $request)
    {
        ...
        if ($request->role == 'eleve') {
            ...
            if ($confirmeconnexioneleve != null) {
                ...
                // 
                $erreur = " Nous n'avons aucun utilisateur de ce nom. Veuillez revérifier vos informations";
                return view('connexion', compact('erreur'));
            }
            ...
            if ($confirmeconnexionet != null) {
                ...
                // 
                $erreur = " Nous n'avons aucun etablisseme de ce nom. Veuillez revérifier vos informations";
                return view('connexion', compact('erreur'));
            }
