        ...
        if ($request->role == 'eleve') {
            ...
            if ($confirmeconnexioneleve != null) {
                ...
                if (($request->login == $confirmeconnexioneleve->login && Hash::check($request->password, $confirmeconnexioneleve->passwordEleve))) {
                    // 
                    // dd('eleve');
                    // return view('Eleve.accueil', compact('eleve', 'prof', 'parent', 'classe', 'et', 'matiere', 'confirmeconnexioneleve'));
                    return redirect(route('eleve', compact('eleve', 'prof', 'parent', 'classe', 'et', 'matiere')));
                } else {
                    // , 'confirmeconnexioneleve'
