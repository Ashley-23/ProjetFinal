...
class SuperAdminAffController extends Controller
{
    ...
    public function listematiere($id)
    {
        ...
        $matiere = Matiere::all();
        // dd($cm);
        $liste = Classe::findOrFail($id);
        $l = DB::table('Classe_Matieres')
            ->select('idClasse')
            ->where('idClasse', $id)
            ->get('idClasse');
        //dd($id);
        // dd($liste);
        // $c = DB::table('Classe_Matieres')
        //     ->select('idClasse')
        //     ->where('idClasse', $liste);
        ...
        $listematiere = DB::table('Classe_Matieres')
            ...
            ->get();
        // $a = array($listematiere);
        // dd($a);
        dd($listematiere);

        return view('Superadmin.ClasseMatiere.listematiere', compact('cm', 'classe', 'matiere', 'liste', 'listematiere'));
    }
