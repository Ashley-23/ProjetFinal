...
class SuperAdminAffController extends Controller
{
    ...
    public function addeleveparentaff($idEleve)
    {
        ...
        $nom = DB::table('Classes')
            ...
            ->first();
        // dd($idEleve);
        return view('Superadmin.Eleve.addparenteleve', compact('eleveedit', 'eleve', 'classe', 'nom'));
    }
    ...
    public function addparentaff()
    {
        ...
        return view('Superadmin.Parent.addparent', compact('parent', 'eleve', 'classe','Relative'));
    }


    // Afficher tous les matieres
    public function addparenteleveeleve(Request $request, $id)
    {
        ...
        Eleve::where('idEleve', $id)->update(
            [
                'idRelative' => $request->classeEleve,
            ]
        );
