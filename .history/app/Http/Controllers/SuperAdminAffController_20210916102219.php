...
class SuperAdminAffController extends Controller
{
    ...
    public function addnoteaff($idmatiere, $idclasse, $ideleve)
    {
        ...
        ->select('Classe_Matieres.idClasse_Matiere')
        ->where(
            ['Classe_Matieres.idClasse_Matiere']
        )
        ...
        //     ->get();
        // dd($listenote);
        return view('Superadmin.ClasseMatiere.addnote', compact('cm', 'classe', 'matiere', 'professeur', 'eleve', 'note', 'eleveaff',));
    }
