...
class SuperAdminAffController extends Controller
{
    ...
    public function addnoteaff($idmatiere, $idclasse, $ideleve)
    {
        ...
        $elevenote = DB::table('Notes')
            ->join('Eleves', 'Eleves.idEleve', '=', 'Notes.idNote')
            ->select('')$listenote = DB::table('Notes')
            ...
            ->get();
        dd($listenote);
        return view('Superadmin.ClasseMatiere.addnote', compact('cm', 'classe', 'matiere', 'professeur', 'eleve', 'note', 'listenote', 'eleveaff'));
    }
