...
class SuperAdminAffController extends Controller
{
    ...
    public function addnoteaff($idclasse, $idmatiere, $ideleve)
    {
        ...
        if ($listeeleveavecnote == "") {
            # code...
            return view('Superadmin.ClasseMatiere.addnoteaff', compact('cm', 'classe', 'matiere', 'professeur', 'eleve', 'note', 'eleveaff', 'idcmaff'));
        } else {
            # code...
            // dd('updatenote');
            return view('Superadmin.ClasseMatiere.updatenoteaff', compact('cm', 'classe', 'matiere', 'professeur', 'eleve', 'note', 'eleveaff', 'idcmaff'));
        }
    }
