...
class SuperAdminAffController extends Controller
{
    ...
    public function addeleve(Request $request)
    {
        ...
        Eleve::create([
            ...
            'prenomEleve' => $request->nomEleve,
            'login' => $request->nomEleve,
            'dateNaissEleve' => $request->nomEleve,
            'sexeEleve' => $request->nomEleve,
            'emailEleve' => $request->nomEleve,
            'passwordEleve' => $request->nomEleve,
            'telephoneEleve' => $request->nomEleve,
