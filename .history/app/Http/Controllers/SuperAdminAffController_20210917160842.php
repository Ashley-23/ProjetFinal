...
class SuperAdminAffController extends Controller
{
    ...
    public function addnoteaff($idclasse, $idmatiere, $ideleve)
    {
        ...
        $ridnote = DB::table('Notes')
            ->join('Eleves','Eleves.idEleve','=','Notes.id')
            // 
        ...
        if ($listeeleveavecnote == "") {
            ...
            # code...
            // dd('updatenote');
            return view('Superadmin.ClasseMatiere.updatenote', compact('cm', 'classe', 'matiere', 'professeur', 'eleve', 'note', 'eleveaff', 'idcmaff'));
        }
    }
    // Afficher tous les matieres
