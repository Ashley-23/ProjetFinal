...
class SuperAdminAffController extends Controller
{
    ...
    public function listeeleve($idclasse, $idmatiere)
    {
        ...
        // $ridmatiere = DB::table('Matieres')
        //     ->join('Classe_Matieres', 'Matieres.idMatiere', '=', 'Classe_Matieres.idMatiere')
        //     ->join('Eleves', 'Eleves.idClasse', '=', 'Classe_Matieres.idClasse')
        //     ->select('Classe_Matieres.*', 'Matieres.*', 'Eleves.*')
        //     ->get();
        // dd($ridmatiere);
        return view('Superadmin.ClasseMatiere.listeeleve', compact('cm', 'classe', 'matiere', 'professeur', 'eleve', 'listeeleve', 'ridcm'));
    }
    ...
    public function listenote($idclasse, $idmatiere)
    {
        // 
        $cm = ClasseMatiere::all();
        $classe = Classe::all();
        ...
        //     ->get();
        // dd($ridmatiere);
        return view('Superadmin.ClasseMatiere.listeeleve', compact('cm', 'classe', 'matiere', 'professeur', 'eleve', 'listeeleve'));
    }
    ...
    public function addnoteaff($idmatiere, $idclasse, $ideleve)
    {
        ...
        //     ->select('Notes.*', 'Eleves.*', 'Classe_Matieres.*')
        //     ->where([
        //         ['Classe_Matieres.idClasse', '=', $idclasse],
        //         ['Classe_Matieres.idMatiere', '=', $idmatiere],
    ...
    public function allnote()
    {
        ...
        return view('Superadmin.ClasseMatiere.allnote', compact('note', 'matiere', 'classe', 'eleve', 'cm'));
    }
