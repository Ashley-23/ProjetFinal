...
class SuperAdminAffController extends Controller
{
    ...
    public function addeleveaff()
    {
        ...
        return view('Superadmin.Eleve.addeleve', compact('eleve'));
    }
    ...
    public function addeleve(Request $request)
    {
        ...
        $this->validate(
            ...
            [
                ...
                'sexeEleve' => 'required|min:3',
                'emailEleve' => 'required|min:3',
                'passwordEleve' => 'required|min:3',
                'telephoneEleve' => 'required|min:3',
        ...
        Eleve::create([
            'nomMatiere' => $request->nomMatiere,
            'nomEleve' => $request->nomMatiere,
            'prenomEleve' => $request->nomMatiere,
            'login' => $request->nomMatiere,
            'dateNaissEleve' => $request->nomMatiere,
            'sexeEleve' => $request->nomMatiere,
            'emailEleve' => $request->nomMatiere,
            'passwordEleve' => $request->nomMatiere,
            'telephoneEleve' => $request->nomMatiere,
            'adresseEleve' => $request->nomMatiere,
        ]);
