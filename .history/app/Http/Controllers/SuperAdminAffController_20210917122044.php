...
class SuperAdminAffController extends Controller
{
    ...
    public function listeeleve($idclasse, $idmatiere)
    {
        ...
        $o = DB::table('Notes')
            ...
            ->join('Classe_Matieres', 'Classe_Matieres.id', '=', 'Notes.idEleve')
            ->get(); //Quand classematiere de classematiere est = classe matier de note
            ->select('Notes.*')
            ->where('Classe_Matieres.id', $r)
            ->get();
        dd($o);
