...
class SuperAdminAffController extends Controller
{
    ...
    public function listeeleve($idclasse, $idmatiere)
    {
        ...
        $listeeleve = DB::table('Classes')
            ...
            ->join('Classes_Matieres', 'Classe_Matieres.idMatiere')
            ->select('Eleves.*', 'Classes.*')
            ->where('Classes.idClasse', $idclasse)
            ->get();
        dd($listeeleve);
    ...
    public function addnoteaff($idmatiere, $idclasse, $ideleve)
    {
        ...
        $listenote = DB::table('Notes')
            ...
            ->and('Classe_Matieres.idMatiere', '=', $idmatiere)
            ->and('Notes.idEleve', '=', $ideleve);
        dd($listenote);
        return view('Superadmin.ClasseMatiere.addnote', compact('cm', 'classe', 'matiere', 'professeur', 'eleve', 'note', 'listenote'));
    }
