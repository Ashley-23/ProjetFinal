...
class SuperAdminAffController extends Controller
{
    ...
    {
         // dd('Affichage de la liste des matieres associés à une classe sur les matieres');
        $cm = ClasseMatiere::all();
        $classe = Classe::all();
        $matiere = Matiere::all();

        return view('Superadmin.ClasseMatiere.listematiere', compact('cm', 'classe', 'matiere'));
    }
