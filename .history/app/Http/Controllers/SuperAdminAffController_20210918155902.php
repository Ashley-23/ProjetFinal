...
return view('Superadmin.accueil',compact('eleve','prof','parent','classe','et',matier))
    ...
    public function addnoteaff($idclasse, $idmatiere, $ideleve)
    {
        ...
        if ($listeeleveavecnote == "") {
            ...
            # code...
            // dd('updatenote');
            return view('Superadmin.ClasseMatiere.updatenote', compact('cm', 'classe', 'matiere', 'professeur', 'eleve', 'note', 'eleveaff', 'idcmaff', 'listeeleveavecnote'));
        }
    }
    // Afficher tous les matieres
