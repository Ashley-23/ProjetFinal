...
class SuperAdminAffController extends Controller
{
    ...
    public function addparentaff()
    {
        ...
        return view('Superadmin.Parent.addparent', compact('parent'));
    }
    ...
    public function addparent(Request $request)
    {
        ...
        Relative::create([
            ...
            'login' => $request->login,
            'dateNaissparent' => $request->dateNaissparent,
            'sexeparent' => $request->sexeparent,
            'emailparent' => $request->emailparent,
            'passwordparent' => Hash::make($request->passwordparent),
            'telephoneparent' => $request->telephoneparent,
