 ...
 @forelse ($classe as $classe)
                         ...
                         <tr> 
                                  ...
                                  <td>
                                                ...
                                                {{-- <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$classe->id) }} "> {{ $classe->login }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$classe->id) }} "> {{ $classe->datenaiss }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$classe->id) }} "> {{ $classe->sexe }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$classe->id) }} "> {{ $classe->email }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$classe->id) }} "> {{ $classe->telephone }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$classe->id) }} "> {{ $classe->photo }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$classe->id) }} "> {{ $classe->adresse }} </a> </td> --}}
