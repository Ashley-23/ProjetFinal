 ...
 @forelse ($matiere as $matiere)
                         ...
                         <tr> 
                                  ...
                                  <td>
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$matiere->idMatiere) }} "> {{ $matiere->nomMatiere }} </a> </td>
                                                {{-- <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$matiere->id) }} "> {{ $matiere->prenom }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$matiere->id) }} "> {{ $matiere->login }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$matiere->id) }} "> {{ $matiere->datenaiss }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$matiere->id) }} "> {{ $matiere->sexe }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$matiere->id) }} "> {{ $matiere->email }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$matiere->id) }} "> {{ $matiere->telephone }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$matiere->id) }} "> {{ $matiere->photo }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$matiere->id) }} "> {{ $matiere->adresse }} </a> </td> --}}
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$matiere->idMatiere) }} "> {{ $matiere->activeMatiere }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
