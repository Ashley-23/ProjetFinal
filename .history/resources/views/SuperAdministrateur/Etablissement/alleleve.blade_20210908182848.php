 ...
 @forelse ($eleve as $eleve)
                         ...
                         <tr> 
                                  ...
                                  <td>
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$eleve->idEleve) }} "> {{ $eleve->loginEleve }} </a> </td>
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$eleve->idEleve) }} "> {{ $eleve->nomClasse }} </a> </td>
