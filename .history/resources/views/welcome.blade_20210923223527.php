                ...
                <div id="main">
                    ...
                    <!-- Featured Post -->
                        <article class="post featured">
                            ...
                            <a href="#" class="image main"><img src="{{asset('images/ecole.jpg')}}" alt="" /></a>
                        ...
                        <section class="posts">
                            <article>
                                <header>
                                    ...
                                    <h2><a href="#">College Saint Joseph<br />
                                    </a></h2>
                                </header>
                                <a href="#" class="image fit"><img src="{{asset('images/csj.jpg')}}" alt="" /></a>
