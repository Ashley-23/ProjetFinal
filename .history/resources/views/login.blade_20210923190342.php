...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Aug 2021 08:56:39 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="login-page-wrap">
        <div class="login-page-content">
            <div class="login-box">
                ...
                <form action="http://www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/index.html" class="login-form">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Entrer le nom d'utilisateur" class="form-control">
                        <i class="far fa-envelope"></i>
                    </div>
                    <div class="form-group">
                        <label>Mot de passe </label>
                        <input type="password" placeholder="Entrer le mot de passe" class="form-control">
            ...
            <div class="sign-up"> Vous n'avez pas de compte ? <a href="{{route('ashleyregister')}}">Inscrivez vous maintenant!</a></div>
        </div>
    </div>
    <!-- Login Page End Here -->
    <!-- jquery-->
