                                ...
                                <div class="col-12-xxxl col-xl-6 col-12">
                                    <div class="kids-details-box mb-5">
                                        <div class="item-content table-responsive">
                                            <table class="table text-nowrap">
                                                <thead>
                                                    <td align="center">Nom des enfants</td>
                                                    <td align="center">Classe des enfants</td>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    @forelse ($mykidsclasse as $mykidsclasse )
                                                        <tr>
                                                          {{-- {{-- <a href="{{route('vue_superadmin_listematiere',$classe->idClasse)}}">  </a>  --}}
                                                            ...
                                                            <td align="center "> <a href="{{route('loginControllerdetailnoteeleve',["idParent"=>$confirmeconnexionparent->idRelative,"idEnfant"=>$mykidsclasse->prenomEleve])}}"> {{$mykidsclasse->nomEleve}}  {{$mykidsclasse->prenomEleve}} </a> </td>
