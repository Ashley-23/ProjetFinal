                ...
                <li class="navbar-item dropdown header-admin">
                    <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                        ...
                        <div class="admin-title">
                            <h5 class="item-title">{{$parento->nomRelative}} {{$parento->prenomRelative}} </h5>
                            <span>Parent</span>
                        </div>
                        <div class="admin-img">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <div class="item-header">
                            <h6 class="item-title">{{$parento->nomRelative}} {{$parento->prenomRelative}}</h6>
                        </div>
                                ...
                                <div class="table-responsive info-table">
                                    <table class="table text-nowrap">
                                        <tbody>
                                            <tr>
                                                <td>Nom :</td>
                                                <td class="font-medium text-dark-medium">{{$parento->nomRelative}}</td>
                                            </tr>
                                            <tr>
                                                <td>Prenom(s):</td>
                                                <td class="font-medium text-dark-medium">{{$parento->prenomRelative}}</td>
                                            </tr>
                                            <tr>
                                                <td>Nom d'utilisateur :</td>
                                                <td class="font-medium text-dark-medium">{{$parento->login}}</td>
                                            </tr>
                                            <tr>
                                                <td>Date de naissance</td>
                                                <td class="font-medium text-dark-medium">{{$parento->dateNaissRelative}}</td>
                                            </tr>
                                            <tr>
                                                <td>E-mail : </td>
                                                <td class="font-medium text-dark-medium">{{$parento->emailRelative}}</td>
                                            </tr>
                                            <tr>
                                                <td>Telephone :</td>
                                                <td class="font-medium text-dark-medium">{{$parento->telephoneRelative}}</td>
                                            </tr>
                                            <tr>
                                                <td>Adresse : </td>
                                                <td class="font-medium text-dark-medium">{{$parento->adresseRelative}}</td>
                                            </tr>
