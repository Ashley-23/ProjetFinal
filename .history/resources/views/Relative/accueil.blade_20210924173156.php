                                        ...
                                        <div class="item-content table-responsive">
                                            <table class="table text-nowrap">
                                                <tbody>
                                                    ...
                                                    @forelse ($mykids as $mykids )
                                                        <tr>
                                                          {{-- {{-- <a href="{{route('vue_superadmin_listematiere',$classe->idClasse)}}">  </a>  --}}
                                                            {{-- <td align="center" > {{$classe->nomClasse}} {{$classe->typeClasse}} </td> --}} 

                                                            <td align="center "> <a href="#"> {{$<td align="center "> <a href="{{route('vue_superadmin_listeclasse',$matiere->idMatiere)}}"> {{$matiere->nomMatiere}} </a> </td>->nomMatiere}} </a> </td>
