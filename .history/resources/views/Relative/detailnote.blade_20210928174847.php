                                            ...
                                            <table class="table display data-table text-nowrap">
                                                ...
                                                <tbody>
                                                    @forelse ($info as $info)
                                                         <tr>
                                                            <td ali > {{$info->nomEleve}} </td>
                                                            <td ali > {{$info->prenomEleve}} </td>
                                                            <td ali > {{$info->nomClasse}} {{$info->typeClasse}} </td>
                                                            <td ali > {{$info->nomMatiere}} </td>
                                                            <td ali > {{$info->note1}} </td>
                                                            <td ali > {{$info->note2}} </td>
                                                            <td ali > {{$info->note3}} </td>
                                                            <td ali > {{$info->moyclasse}} </td>
