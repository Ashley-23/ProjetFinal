                ...
                <li class="navbar-item dropdown header-admin">
                    <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                        ...
                        <div class="admin-title">
                            <h5 class="item-title">{{$confirmeconnexionparent->nomEleve}} {{$confirmeconnexionparent->prenomEleve}} </h5>
                            <span>Eleve</span>
                        </div>
                        <div class="admin-img">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <div class="item-header">
                            <h6 class="item-title">{{$confirmeconnexionparent->nomEleve}} {{$confirmeconnexionparent->prenomEleve}}</h6>
                        </div>
                                ...
                                <div class="table-responsive info-table">
                                    <table class="table text-nowrap">
                                        <tbody>
                                            <tr>
                                                <td>Nom :</td>
                                                <td class="font-medium text-dark-medium">{{$confirmeconnexionparent->nomEleve}}</td>
                                            </tr>
                                            <tr>
                                                <td>Prenom(s):</td>
                                                <td class="font-medium text-dark-medium">{{$confirmeconnexionparent->prenomEleve}}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="font-medium text-dark-medium">{{$confirmeconnexionparent->dateNaissEleve}}</td>
                                            </tr>
                                            <tr>
                                                <td>E-mail : </td>
                                                <td class="font-medium text-dark-medium">{{$confirmeconnexionparent->emailEleve}}</td>
                                            </tr>
                                            <tr>
                                                <td>Telephone :</td>
                                                <td class="font-medium text-dark-medium">{{$confirmeconnexionparent->telephoneEleve}}</td>
                                            </tr>
                                            <tr>
                                                <td>Adresse : </td>
                                                <td class="font-medium text-dark-medium">{{$confirmeconnexionparent->adresseEleve}}</td>
                                            </tr>
                                            <tr>
                                                <td>Classe:</td>
