                ...
                <li class="navbar-item dropdown header-admin">
                    <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                        ...
                        <div class="admin-title">
                            <h5 class="item-title">{{$confirmeconnexionparent->nomEleve}} {{$confirmeconnexioneleve->prenomEleve}} </h5>
                            <span>Eleve</span>
                        </div>
                        <div class="admin-img">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <div class="item-header">
                            <h6 class="item-title">{{$confirmeconnexioneleve->nomEleve}} {{$confirmeconnexioneleve->prenomEleve}}</h6>
                        </div>
