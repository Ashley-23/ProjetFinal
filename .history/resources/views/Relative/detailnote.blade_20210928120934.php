                ...
                <li class="navbar-item dropdown header-admin">
                    <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                        ...
                        <div class="admin-title">
                            <h5 class="item-title">{{$info->nomRelative}} {{$info->prenomRelative}} </h5>
                            <span>Parent</span>
                        </div>
                        <div class="admin-img">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <div class="item-header">
                            <h6 class="item-title">{{$info->nomRelative}} {{$info->prenomRelative}}</h6>
                        </div>
                                ...
                                <div class="table-responsive info-table">
                                    <table class="table text-nowrap">
                                        <tbody>
                                            <tr>
                                                <td>Nom :</td>
                                                <td class="font-medium text-dark-medium">{{$info->nomRelative}}</td>
                                            </tr>
                                            <tr>
                                                <td>Prenom(s):</td>
                                                <td class="font-medium text-dark-medium">{{$info->prenomRelative}}</td>
                                            </tr>
                                            <tr>
                                                <td>Nom d'utilisateur :</td>
                                                <td class="font-medium text-dark-medium">{{$info->login}}</td>
                                            </tr>
                                            <tr>
                                                <td>Date de naissance</td>
                                                <td class="font-medium text-dark-medium">{{$info->dateNaissRelative}}</td>
                                            </tr>
                                            <tr>
                                                <td>E-mail : </td>
                                                <td class="font-medium text-dark-medium">{{$info->emailRelative}}</td>
                                            </tr>
                                            <tr>
                                                <td>Telephone :</td>
                                                <td class="font-medium text-dark-medium">{{$info->telephoneRelative}}</td>
                                            </tr>
                                            <tr>
                                                <td>Adresse : </td>
                                                <td class="font-medium text-dark-medium">{{$info->adresseRelative}}</td>
                                            </tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    <div class="ui-alart-box">
                                                        <div class="alert icon-alart bg-pink2" role="alert">
                                                            ...
                                                            {{$info->nomEleve}} {{$info->prenomEleve}} enfants n'a aucune note
                                                        </div> 
                                                </div>
                                                    @endforelse
