                                            ...
                                            <table class="table display data-table text-nowrap">
                                                ...
                                                <tbody>
                                                    @forelse ($info as $info)
                                                         <tr>
                                                            <td align="" > {{$info->nomEleve}} </td>
                                                            <td align="" > {{$info->prenomEleve}} </td>
                                                            <td align="" > {{$info->nomClasse}} {{$info->typeClasse}} </td>
                                                            <td align="" > {{$info->nomMatiere}} </td>
                                                            <td align="" > {{$info->note1}} </td>
                                                            <td align="" > {{$info->note2}} </td>
                                                            <td align="" > {{$info->note3}} </td>
                                                            <td align="" > {{$info->moyclasse}} </td>
