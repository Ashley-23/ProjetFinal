                        ...
                        <div class="card-body">
                            <div class="heading-layout1">
                                <div class="item-title">
                                    <h3>Information de mon enfant</h3>
                                </div>
                            </div>
                                ...
                                <div class="table-responsive info-table">
                                    <table class="table text-nowrap">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Parent : </td>
                                                <td class="font-medium text-dark-medium">{{$parent->nomRelative}} {{$parent->prenomRelative}} </td>
                                            </tr>
                            ...
                            <div class="card dashboard-card-eleven">
                                <div class="card-body">
                                    ...
                                    <div class="ui-btn-wrap">
                                        <ul>
                                            <a href="{{route('dashboardparent',$parent->idRelative)}}"> <li><button type="button" class="btn-fill-md radius-4 text-light bg-light-sea-green"> Voir la liste de mes enfants </button></li> </a>
                                            ...
                                            <table class="table display data-table text-nowrap">
                                                ...
                                                <tbody>
                                                    @forelse ($info as $info)
                                                        <tr>
                                                            <td align="center" > {{$info->nomEleve}} </td>
                                                            <td align="center" > {{$info->prenomEleve}} </td>
                                                            <td align="center" > {{$info->nomClasse}} {{$info->typeClasse}} </td>
                                                            <td align="center" > {{$info->nomMatiere}} </td>
                                                            <td align="center" > {{$info->note1}} </td>
                                                            <td align="center" > {{$info->note2}} </td>
                                                            <td align="center" > {{$info->note3}} </td>
                                                            <td align="center" > {{$info->moyclasse}} </td>
