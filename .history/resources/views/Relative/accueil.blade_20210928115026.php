                                                    ...
                                                    @forelse ($mykidsclasse as $mykidsclasse )
                                                        <tr>
                                                          {{-- {{-- <a href="{{route('vue_superadmin_listematiere',$classe->idClasse)}}">  </a>  --}}
                                                            ...
                                                            <td align="center "> <a href="{{route('loginControllerdetailnoteeleve',["idParent"=>$confirmeconnexionparent->idRelative,"idEnfant"=>])}}"> {{$mykidsclasse->nomEleve}}  {{$mykidsclasse->prenomEleve}} </a> </td>
