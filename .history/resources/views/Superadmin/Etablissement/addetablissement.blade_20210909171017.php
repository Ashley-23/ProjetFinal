                            ...
                            <form  action="{{route('vue_superadmin_addetablissement')}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Nom </label>
                                        <input type="text" placeholder="" class="form-control" name="nomEtablissement">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Adresse</label>
                                        <input type="text" placeholder="" class="form-control" name="adresseEtablissement">
                                         {!! $errors->first('adresseEtablissement','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>E-mail</label>
                                        <input type="email" placeholder="" class="form-control" name="emailEtablissement">
                                    ...
                                    <div class="col-12 form-group mg-t-8">
                                        ...
                                        <a href="{{route('vue_superadmin_alletablissement')}}"></a>
                                        <button type="button" class="btn-fill-lmd radius-4 text-light bg-true-v"> Voir la liste</button>
