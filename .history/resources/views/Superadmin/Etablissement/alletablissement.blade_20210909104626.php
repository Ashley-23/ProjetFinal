 ...
 @forelse ($etablissement as $etablissement)
                         ...
                         <tr> 
                                  ...
                                  <td>
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEta) }} "> {{ $etablissement->nomEta }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEta) }} "> {{ $etablissement->prenomEta }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEta) }} "> {{ $etablissement->login }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEta) }} "> {{ $etablissement->dateNaissEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEta) }} "> {{ $etablissement->sexeEleve }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEta) }} "> {{ $etablissement->emailEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEta) }} "> {{ $etablissement->telephoneEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEta) }} "> {{ $etablissement->PhotoEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEta) }} "> {{ $etablissement->adresseEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEta) }} "> {{ $etablissement->idClasse }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEta) }} "> {{ $etablissement->activeEleve }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
