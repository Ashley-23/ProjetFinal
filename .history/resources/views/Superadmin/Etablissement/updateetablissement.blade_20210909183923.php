                            ...
                            <form  action="{{route('vue_superadmin_addetablissement',$etablissementedit)}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Nom </label>
                                        <input type="text" placeholder="{{$etablissementedit->nomEtablissement}}"  placeholder="{{$etablissementedit->nomEtablissement}}" class="form-control" name="nomEtablissement">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        ...
                                        <input type="tel" placeholder="{{$etablissementedit->telephoneEtablissement}}" class="form-control"  name="telephoneEtablissement">
