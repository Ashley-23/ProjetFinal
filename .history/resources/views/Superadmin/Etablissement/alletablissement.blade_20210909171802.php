    ...
    <div class="card height-auto">
        <div class="card-body">
            ...
            <div class="ui-btn-wrap">
                <ul>
                    <a href="{{route('vue_superadmin_addetablissementaff')}}"> <li><button type="button" class="btn-fill-xl radius-30 text-light shadow-light-sea-green bg-light-sea-green">  </button></li> </a>
                    <li><button type="button" class="btn-fill-md radius-4 text-light bg-light-sea-green">Ajouter un etablissement </button></li>
                </ul>
            </div>
