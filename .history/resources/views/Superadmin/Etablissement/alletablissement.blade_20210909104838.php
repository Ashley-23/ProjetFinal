 ...
 @forelse ($etablissement as $etablissement)
                         ...
                         <tr> 
                                  ...
                                  <td>
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEtablissement) }} "> {{ $etablissement->PhotoEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEtablissement) }} "> {{ $etablissement->adresseEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEtablissement) }} "> {{ $etablissement->idClasse }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEtablissement) }} "> {{ $etablissement->activeEleve }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
