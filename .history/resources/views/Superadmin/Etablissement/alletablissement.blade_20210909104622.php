 ...
 @forelse ($etablissement as $etablissement)
                         ...
                         <tr> 
                                  ...
                                  <td>
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->id) }} "> {{ $etablissement->nom }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->id) }} "> {{ $etablissement->prenom }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->id) }} "> {{ $etablissement->login }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->id) }} "> {{ $etablissement->dateNaissEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->id) }} "> {{ $etablissement->sexeEleve }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->id) }} "> {{ $etablissement->emailEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->id) }} "> {{ $etablissement->telephoneEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->id) }} "> {{ $etablissement->PhotoEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->id) }} "> {{ $etablissement->adresseEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->id) }} "> {{ $etablissement->idClasse }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->id) }} "> {{ $etablissement->activeEleve }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
