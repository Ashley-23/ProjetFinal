...
<div class="dashboard-content-one">
            ...
            <div class="heading-layout1">
                ...
                <div class="ui-btn-wrap">
                    <ul>
                        ...
                        <li><button type="button" class="btn-fill-lmd radius-4 text-true-v border-true-v"> <a href="{{route('vue_superadmin_addetablissementaff')}}"> Ajouter un etablissement </a> </button></li>
                        <li><button type="button" class="btn-fill-xl radius-30 text-light shadow-light-sea-green bg-light-sea-green"> <a href="{{route('vue_superadmin_addetablissementaff')}}"> Ajouter un etablissement </a> </button></li>
                    </ul>
                </div>
 ...
 @forelse ($etablissement as $etablissement)
                         ...
                         <tr> 
                                  ...
                                  <td>
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEtablissement) }} "> {{ $etablissement->nomEtablissement }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEtablissement) }} "> {{ $etablissement->username }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEtablissement) }} "> {{ $etablissement->codeEtablissement }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEtablissement) }} "> {{ $etablissement->login }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEtablissement) }} "> {{ $etablissement->password }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEtablissement) }} "> {{ $etablissement->adresseEtablissement }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEtablissement) }} "> {{ $etablissement->telephoneEtablissement }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEtablissement) }} "> {{ $etablissement->activeEtablissement }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
