                    ...
                    <div class="info-table table-responsive">
                        ...
                        <table class="table text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Nom:</td>
                                    <td class="font-medium text-dark-medium"> {{ $detail->nom }} </td>
                                </tr>
                                <tr>
                                    <td>Prenom :</td>
                                    <td class="font-medium text-dark-medium"> {{ $detail->prenom }} </td>
                                </tr>
                                <tr>
                                    <td>Login:</td>
                                    <td class="font-medium text-dark-medium"> {{ $detail->login }} </td>
                                </tr>
                                <tr>
                                    <td>Date de naissance:</td>
                                    <td class="font-medium text-dark-medium"> {{ $detail->datenaiss }} </td>
                                </tr>
                                <tr>
                                    <td>Sexe:</td>
