                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label"> 
                                                            {{-- <a href=" {{ route('vue_superadmin_detailetablissement') }},{{$id }}"> --}}
                                                                {{ $etablissement->idEleve }}
                                                            {{-- </a> --}}
                                                         </label>
                                                    </div>
                                                </td>
                                                {{-- <td class="text-center"><img src="img/figure/student2.png" alt="student"></td> --}}
                                                {{-- <td>  <a href=""> {{ $etablissement->id }} </a> </td> --}}
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEleve) }} "> {{ $etablissement->nomEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEleve) }} "> {{ $etablissement->prenomEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEleve) }} "> {{ $etablissement->login }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEleve) }} "> {{ $etablissement->dateNaissEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEleve) }} "> {{ $etablissement->sexeEleve }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEleve) }} "> {{ $etablissement->emailEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEleve) }} "> {{ $etablissement->telephoneEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEleve) }} "> {{ $etablissement->PhotoEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEleve) }} "> {{ $etablissement->adresseEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEleve) }} "> {{ $etablissement->idClasse }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEleve) }} "> {{ $etablissement->activeEleve }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
