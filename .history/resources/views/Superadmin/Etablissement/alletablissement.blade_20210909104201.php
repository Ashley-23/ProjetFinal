 ...
 @forelse ($etablissement as $etablissement)
                         ...
                         <tr> 
                                  ...
                                  <td>
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEleve) }} "> {{ $eleve->nomEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$eleve->idEleve) }} "> {{ $eleve->prenomEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$eleve->idEleve) }} "> {{ $eleve->login }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$eleve->idEleve) }} "> {{ $eleve->dateNaissEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$eleve->idEleve) }} "> {{ $eleve->sexeEleve }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$eleve->idEleve) }} "> {{ $eleve->emailEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$eleve->idEleve) }} "> {{ $eleve->telephoneEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$eleve->idEleve) }} "> {{ $eleve->PhotoEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$eleve->idEleve) }} "> {{ $eleve->adresseEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$eleve->idEleve) }} "> {{ $eleve->idClasse }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$eleve->idEleve) }} "> {{ $eleve->activeEleve }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
