                        ...
                        <div class="card-body">
                            ...
                            <form  action="{{route('vue_superadmin_addetablissement',$etablissementedit)}}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Adresse</label>
                                        <input type="text" placeholder="{{$etablissementedit->adresseEtablissement}}" valuer="{{$etablissementedit->adresseEtablissement}}" class="form-control" name="adresseEtablissement">
                                         {!! $errors->first('adresseEtablissement','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>E-mail</label>
                                        <input type="email" placeholder="{{$etablissementedit->emailEtablissement}}" value="{{$etablissementedit->emailEtablissement}}" class="form-control" name="emailEtablissement">
                                         {!! $errors->first('emailEtablissement','<span class="error">:message </span>') !!}
                                    </div>   
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Telephone</label>
                                        <input type="tel" placeholder="{{$etablissementedit->telephoneEtablissement}}" placeholder="{{$etablissementedit->telephoneEtablissement}}" class="form-control"  name="telephoneEtablissement">
