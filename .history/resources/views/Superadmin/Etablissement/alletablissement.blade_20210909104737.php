 ...
 @forelse ($etablissement as $etablissement)
                         ...
                         <tr> 
                                  ...
                                  <td>
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEtablissement) }} "> {{ $etablissement->dateNaissEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEtablissement) }} "> {{ $etablissement->sexeEleve }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEtablissement) }} "> {{ $etablissement->emailEleve }} </a> </td>
