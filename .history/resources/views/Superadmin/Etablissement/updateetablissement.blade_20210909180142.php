                            ...
                            <form  action="{{route('vue_superadmin_addetablissement',$etablissementedit)}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Nom </label>
                                        <input type="text" placeholder="{{$etablissementedit->nomEtablissement}}" class="form-control" name="nomEtablissement">
                                        {!! $errors->first('nomEtablissement','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Login</label>
                                        <input type="text" placeholder="{{$etablissementedit->login}}" class="form-control" name="login">
                                        {!! $errors->first('login','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Adresse</label>
                                        <input type="text" placeholder="{{$etablissementedit->adresseEtablissement}}" class="form-control" name="adresseEtablissement">
                                         {!! $errors->first('adresseEtablissement','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>E-mail</label>
                                        <input type="email" placeholder="{{$etablissementedit->emailEtablissement}}" class="form-control" name="emailEtablissement">
                                         {!! $errors->first('emailEtablissement','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Mot de passse </label>
                                        <input type="password" placeholder="{{$etablissementedit->password}}" class="form-control" name="password">
                                        {!! $errors->first('password','<span class="error">:message </span>') !!}
                                    </div>     
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Telephone</label>
                                        <input type="text" placeholder="{{$etablissementedit->ntelephoneEtablissement}}" class="form-control" name="telephoneEtablissement">
