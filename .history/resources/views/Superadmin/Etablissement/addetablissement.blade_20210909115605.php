                ...
                <div class="card height-auto">
                    <form action="{{route('vue_superadmin_addetablissement')}}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <form class="new-added-form" action="{{route('vue_superadmin_addetablissement')}}" method="POST">
                                    {{ csrf_field() }}
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Code</label>
                                        <input type="text" placeholder="" class="form-control" name="codeEtablissement">
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Login</label>
