                        ...
                        <div class="card-body">
                            ...
                            <form  action="{{route('vue_superadmin_addetablissement',$etablissementedit)}}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Adresse</label>
                                        <input type="text" placeholder="{{$etablissementedit->adresseEtablissement}}" placeholder="{{$etablissementedit->adresseEtablissement}}" class="form-control" name="adresseEtablissement">
