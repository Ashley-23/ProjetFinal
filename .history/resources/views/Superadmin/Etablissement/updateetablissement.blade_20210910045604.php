                        ...
                        <div class="card-body">
                            ...
                            <form  action="{{route('vue_superadmin_addetablissement',$etablissementedit)}}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>E-mail</label>
                                        <input type="email" placeholder="{{$etablissementedit->emailEtablissement}}" value="old{{$etablissementedit->emailEtablissement}}" class="form-control" name="emailEtablissement">
