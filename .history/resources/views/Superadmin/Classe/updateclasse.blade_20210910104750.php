                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        ...
                                        <div class="item-number"><span class="counter" data-num=" {{ $classe->count() }} "> {{ $etablissement->count() }} </span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card height-auto">
                    {{-- <form action="{{route('vue_superadmin_updateetablissement')}}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <form  action="{{route('vue_superadmin_updateetablissement',$etablissementedit->idEtablissement)}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Nom </label>
                                        <input type="text"   value="{{old('nomEtablissement') ?? $etablissementedit->nomEtablissement}}" class="form-control" name="nomEtablissement">
                                        {!! $errors->first('nomEtablissement','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Login</label>
                                        <input type="text"  value="{{old('login') ?? $etablissementedit->login}}" class="form-control" name="login">
                                        {!! $errors->first('login','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Adresse</label>
                                        <input type="text"  value="{{old('adresseEtablissement') ??$etablissementedit->adresseEtablissement}}" class="form-control" name="adresseEtablissement">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        ...
                                        <input type="tel"  value="{{old('telephoneEtablissement') ??$etablissementedit->telephoneEtablissement}}" class="form-control"  name="telephoneEtablissement">
