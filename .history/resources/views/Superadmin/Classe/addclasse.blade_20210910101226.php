                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu sub-group-active">
                                <li class="nav-item">
                                    <a href="{{route('vue_superadmin_allclasseClasse')}}" class="nav-link "><i class="fas fa-angle-right"></i>Etablissement
                                        </a>
                                </li>
                                <li class="nav-item">
                ...
                <form  action="{{route('vue_superadmin_addclasse')}}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            <label>Nom </label>
                            <input type="text" placeholder="" class="form-control" name="nomclasseClasse">
                            {!! $errors->first('nomclasseClasse','<span class="error">:message </span>') !!}
                        </div>
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            <label>Type</label>
                            <input type="text" placeholder="" class="form-control" name="typeClasse">
                            {!! $errors->first('login','<span class="error">:message </span>') !!}
                        </div>
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            <label>Adresse</label>
                            <input type="text" placeholder="" class="form-control" name="adresseclasseClasse">
                             {!! $errors->first('adresseclasseClasse','<span class="error">:message </span>') !!}
                        </div>
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            <label>E-mail</label>
                            <input type="email" placeholder="" class="form-control" name="emailclasseClasse">
                             {!! $errors->first('emailclasseClasse','<span class="error">:message </span>') !!}
                        </div>
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                        ...
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            ...
                            <input type="tel" placeholder="" class="form-control"  name="telephoneclasseClasse">
                            {!! $errors->first('telephoneclasseClasse','<span class="error">:message </span>') !!}
                        </div>
                        ...
                        <div class="col-12 form-group mg-t-8">
                            ...
                            <a href="{{route('vue_superadmin_allclasseClasse')}}"><button type="button" class="btn-fill-lmd radius-4 text-light bg-true-v"> Voir la liste</button></a>
