 ...
 @forelse ($classe as $classe)
                         ...
                         <tr> 
                                  ...
                                  <td>
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$classe->idClasse) }} "> {{ $classe->nomEtablissement }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$classe->idClasse) }} "> {{ $classe->login }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$classe->idClasse) }} "> {{ $classe->adresseEtablissement }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$classe->idClasse) }} "> {{ $classe->emailEtablissement }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$classe->idClasse) }} "> {{ $classe->password }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$classe->idClasse) }} "> {{ $classe->telephoneEtablissement }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$classe->idClasse) }} "> {{ $classe->activeEtablissement }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
