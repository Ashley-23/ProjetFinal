                ...
                <div class="card height-auto">
                    {{-- <form action="{{route('vue_superadmin_updateetablissement')}}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <form  action="{{route('vue_superadmin_updateclasse',$classeedit->idClasse)}}" method="POST">
                                <input type="hidden" name="method" value="PUT">
                                    {{ csrf_field() }}
                                    
                                    <div class="row">
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Acienne valeur du nom </label>
                                            <input type="text"  placeholder="{{$classeedit->nomClasse}}"  value="{{old('nomClasse') ?? $classeedit->nomClasse}}" class="form-control" name="nomClasse">
                                            {!! $errors->first('nomClasse','<span class="error">:message </span>') !!}
                                        </div>
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Ancienne valeur du type </label>
                                            <input type="text"   placeholder="{{$classeedit->typeClasse}" value="{{old('typeClasse') ?? $classeedit->typeClasse}}" class="form-control" name="typeClasse">
                                ...
                                <div class="row">
                                    ...
                                    {{-- <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Nom </label>
                                        <input type="text"   value="{{old('nomClasse') ?? $classeedit->nomClasse}}" class="form-control" name="nomClasse">
                                        {!! $errors->first('nomClasse','<span class="error">:message </span>') !!}
                                    </div> --}}
