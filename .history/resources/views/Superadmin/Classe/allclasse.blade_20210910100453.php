 ...
 @forelse ($classe as $classe)
                         ...
                         <tr> 
                                  ...
                                  <td>
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detai',$classe->idClasse) }} "> {{ $classe->nomClasse }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablisseme',$classe->idClasse) }} "> {{ $classe->typeClasse }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablisseme',$classe->idClasse) }} "> {{ $classe->activeClasse }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
