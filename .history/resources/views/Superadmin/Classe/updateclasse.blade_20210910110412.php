                                ...
                                <input type="hidden" name="method" value="PUT">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            ...
                                            <input type="text"  placeholder=""  value="{{old('nomClasse') ?? $classeedit->nomClasse}}" class="form-control" name="nomClasse">
                                            {!! $errors->first('nomClasse','<span class="error">:message </span>') !!}
                                        </div>
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Ancienne valeur du type </label>
                                            <input type="text"   placeholder="" value="{{old('typeClasse') ?? $classeedit->typeClasse}}" class="form-control" name="typeClasse">
