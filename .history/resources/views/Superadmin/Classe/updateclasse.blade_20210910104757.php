             ...
             <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    ...
                    <ul>
                        ...
                        <li>Modifier les informations d'une classe</li>
                    </ul>
                ...
                <div class="card height-auto">
                    {{-- <form action="{{route('vue_superadmin_updateetablissement')}}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <form  action="{{route('vue_superadmin_updateetablissement',$classeedit->idEtablissement)}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Nom </label>
                                        <input type="text"   value="{{old('nomEtablissement') ?? $classeedit->nomEtablissement}}" class="form-control" name="nomEtablissement">
                                        {!! $errors->first('nomEtablissement','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Login</label>
                                        <input type="text"  value="{{old('login') ?? $classeedit->login}}" class="form-control" name="login">
                                        {!! $errors->first('login','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Adresse</label>
                                        <input type="text"  value="{{old('adresseEtablissement') ??$classeedit->adresseEtablissement}}" class="form-control" name="adresseEtablissement">
                                         {!! $errors->first('adresseEtablissement','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>E-mail</label>
                                        <input type="email"   value="{{old('emailEtablissement') ?? $classeedit->emailEtablissement}}" class="form-control" name="emailEtablissement">
                                         {!! $errors->first('emailEtablissement','<span class="error">:message </span>') !!}
                                    </div>   
                                    {{-- value="{{$classeedit->emailEtablissement}}" --}}
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Telephone</label>
                                        <input type="tel"  value="{{old('telephoneEtablissement') ??$classeedit->telephoneEtablissement}}" class="form-control"  name="telephoneEtablissement">
