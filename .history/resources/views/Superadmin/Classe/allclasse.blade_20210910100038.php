 ...
 @forelse ($classe as $classe)
                         ...
                         <tr> 
                                  ...
                                  <td>
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$classe->idEtablissement) }} "> {{ $classe->nomEtablissement }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$classe->idEtablissement) }} "> {{ $classe->login }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$classe->idEtablissement) }} "> {{ $classe->adresseEtablissement }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$classe->idEtablissement) }} "> {{ $classe->emailEtablissement }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$classe->idEtablissement) }} "> {{ $classe->password }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$classe->idEtablissement) }} "> {{ $classe->telephoneEtablissement }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$classe->idEtablissement) }} "> {{ $classe->activeEtablissement }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
