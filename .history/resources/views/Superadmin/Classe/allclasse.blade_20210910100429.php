    ...
    <div class="card height-auto">
        <div class="card-body">
            ...
            <div class="ui-btn-wrap">
                <ul>
                    <a href="{{route('vue_superadmin_addetablissementaff')}}"> <li><button type="button" class="btn-fill-md radius-4 text-light bg-light-sea-green">Ajouter une classe </button></li> </a>
