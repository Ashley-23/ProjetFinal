 ...
 @forelse ($classe as $classe)
                         ...
                         <tr> 
                                  ...
                                  <td>
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detail',$classe->idClasse) }} "> {{ $classe->nomClasse }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detail',$classe->idClasse) }} "> {{ $classe->typeClasse }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detail',$classe->idClasse) }} "> {{ $classe->activeClasse }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
