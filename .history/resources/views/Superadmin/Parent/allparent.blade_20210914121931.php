...
<div class="dashboard-content-one">
 ...
 @forelse ($parent as $parent)
                         ...
                         <tr> 
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idEleve) }} "> {{ $parent->nomEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idEleve) }} "> {{ $parent->prenomEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idEleve) }} "> {{ $parent->login }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idEleve) }} "> {{ $parent->dateNaissEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idEleve) }} "> {{ $parent->sexeEleve }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idEleve) }} "> {{ $parent->emailEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idEleve) }} "> {{ $parent->telephoneEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idEleve) }} "> {{ $parent->adresseEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idEleve) }} "> {{ $parent->activeEleve }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
