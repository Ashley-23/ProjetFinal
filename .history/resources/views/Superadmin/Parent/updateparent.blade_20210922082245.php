                            ...
                            <form  action="{{route('vue_superadmin_updateeleve',$parentedit->idRelative)}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Nom </label>
                                        <input type="text"   value="{{old('nomRelative') ?? $parentedir->nomEleve}}" class="form-control" name="nomEleve">
                                        {!! $errors->first('nomEleve','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Prenom </label>
                                        <input type="text"   value="{{old('prenomRelative') ?? $parentedir->prenomEleve}}" class="form-control" name="prenomEleve">
                                        {!! $errors->first('prenomEleve','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Login</label>
                                        <input type="text"  value="{{old('login') ?? $parentedir->login}}" class="form-control" name="login">
                                        {!! $errors->first('login','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Date de naissance</label>
                                        <input type="date"  value="{{old('dateNaissRelative') ?? $parentedir->dateNaissEleve}}" class="form-control" name="dateNaissEleve">
