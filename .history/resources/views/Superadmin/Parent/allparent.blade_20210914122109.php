...
<div class="dashboard-content-one">
 ...
 @forelse ($parent as $parent)
                         ...
                         <tr> 
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idRelative) }} "> {{ $parent->nomRelative }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idRelative) }} "> {{ $parent->prenomRelative }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idRelative) }} "> {{ $parent->login }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idRelative) }} "> {{ $parent->dateNaissRelative }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idRelative) }} "> {{ $parent->sexeRelative }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idRelative) }} "> {{ $parent->emailRelative }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idRelative) }} "> {{ $parent->telephoneRelative }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idRelative) }} "> {{ $parent->adresseRelative }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idRelative) }} "> {{ $parent->activeRelative }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
