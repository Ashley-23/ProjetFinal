...
<div class="dashboard-content-one">
 ...
 @forelse ($parent as $parent)
                         ...
                         <tr> 
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idRelative) }} "> {{ $parent->nomEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idRelative) }} "> {{ $parent->prenomEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idRelative) }} "> {{ $parent->login }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idRelative) }} "> {{ $parent->dateNaissEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idRelative) }} "> {{ $parent->sexeEleve }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idRelative) }} "> {{ $parent->emailEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idRelative) }} "> {{ $parent->telephoneEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idRelative) }} "> {{ $parent->adresseEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->idRelative) }} "> {{ $parent->activeEleve }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
