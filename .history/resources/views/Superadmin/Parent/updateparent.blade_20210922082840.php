             ...
             <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    ...
                    <ul>
                        ...
                        <li>Modifier les informations d'un parent</li>
                    </ul>
                ...
                <div class="card height-auto">
                        <div class="card-body">
                            ...
                            <form  action="{{route('vue_superadmin_updateparent',$parentedit->idRelative)}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Nom </label>
                                        <input type="text"   value="{{old('nomRelative') ?? $parentedit->nomRelative}}" class="form-control" name="nomRelative">
                                        {!! $errors->first('nomRelative','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Prenom </label>
                                        <input type="text"   value="{{old('prenomRelative') ?? $parentedit->prenomRelative}}" class="form-control" name="prenomRelative">
                                        {!! $errors->first('prenomRelative','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Login</label>
                                        <input type="text"  value="{{old('login') ?? $parentedit->login}}" class="form-control" name="login">
                                        {!! $errors->first('login','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Date de naissance</label>
                                        <input type="date"  value="{{old('dateNaissRelative') ?? $parentedit->dateNaissRelative}}" class="form-control" name="dateNaissRelative">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Adresse</label>
                                        <input type="text"  value="{{old('adresseRelative') ??$parentedit->adresseRelative}}" class="form-control" name="adresseRelative">
                                         {!! $errors->first('adresseRelative','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>E-mail</label>
                                        <input type="email"   value="{{old('emailRelative') ?? $parentedit->emailRelative}}" class="form-control" name="emailRelative">
                                         {!! $errors->first('emailRelative','<span class="error">:message </span>') !!}
                                    </div>   
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Telephone</label>
                                        <input type="tel"  value="{{old('telephoneRelative') ??$parentedit->telephoneRelative}}" class="form-control"  name="telephoneRelative">
                                     ...
                                     {{-- <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        ...
                                        <select class="select2" name="classeEleve" multiple>
...
{{--                                         
                                    ...
                                    <div class="col-12 form-group mg-t-8">
                                        ...
                                        <a href="{{route('vue_superadmin_allp')}}"><button type="button" class="btn-fill-lmd radius-4 text-light bg-true-v"> Voir la liste</button></a>
