                        ...
                        <div class="card-body">
                            ...
                            <form  action="{{route('vue_superadmin_updateeleve',$parentedit->idRelative)}}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>E-mail</label>
                                        <input type="email"   value="{{old('emailEleve') ?? $parent->emailEleve}}" class="form-control" name="emailEleve">
                                         {!! $errors->first('emailEleve','<span class="error">:message </span>') !!}
                                    </div>   
                                    {{-- value="{{$eleveedit->emailEleve}}" --}}
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Telephone</label>
                                        <input type="tel"  value="{{old('telephoneEleve') ??$parent->telephoneEleve}}" class="form-control"  name="telephoneEleve">
