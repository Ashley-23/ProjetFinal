                            ...
                            <form  action="{{route('vue_superadmin_updateeleve',$parentedit->idRelative)}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Nom </label>
                                        <input type="text"   value="{{old('nomRelative') ?? $parentedit->nomRelative}}" class="form-control" name="nomEleve">
                                        {!! $errors->first('nomEleve','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Prenom </label>
                                        <input type="text"   value="{{old('prenomRelative') ?? $parentedit->prenomRelative}}" class="form-control" name="prenomEleve">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        ...
                                        <input type="date"  value="{{old('dateNaissRelative') ?? $parentedit->dateNaissRelative}}" class="form-control" name="dateNaissEleve">
