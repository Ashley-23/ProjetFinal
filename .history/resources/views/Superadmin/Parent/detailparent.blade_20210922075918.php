                    ...
                    <div class="info-table table-responsive">
                        ...
                        <table class="table text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Nom:</td>
                                    <td class="font-medium text-dark-medium"> {{ $parentdetail->nomEleve }} </td>
                                </tr>
                                <tr>
                                    <td>Prenom:</td>
                                    <td class="font-medium text-dark-medium"> {{ $parentdetail->prenomEleve }} </td>
                                </tr>
                                <tr>
                                    <td>Login:</td>
                                ...
                                <tr>
                                    ...
                                    <td class="font-medium text-dark-medium"> {{ $parentdetail->dateNaissEleve }} </td>
                                </tr>
                                <tr>
                                    <td>Sexe:</td>
                                    <td class="font-medium text-dark-medium"> {{ $parentdetail->sexeEleve }} </td>
                                </tr>
                                <tr>
                                    <td>E-mail:</td>
                                    <td class="font-medium text-dark-medium"> {{ $parentdetail->emailEleve }} </td>
                                </tr>
                                <tr>
                                    <td>Telephone:</td>
                                    <td class="font-medium text-dark-medium"> {{ $parentdetail->telephoneEleve }} </td>
                                </tr>
                                <tr>
                                    <td>Adresse:</td>
                                    <td class="font-medium text-dark-medium"> {{ $->adresseEleve }} </td>
                                </tr>
                                <tr>
                                    <td>Active:</td>
                                    <td class="font-medium text-dark-medium"> {{ $->activeEleve }} </td>
                                </tr>
                                <tr>
                                    <td>Crée le :</td>
                                    <td class="font-medium text-dark-medium"> {{ $->created_at }} </td>
                                </tr>
                                <tr>
                                    <td>Mise à jour le :</td>
                                    <td class="font-medium text-dark-medium"> {{ $->updated_at }} </td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
