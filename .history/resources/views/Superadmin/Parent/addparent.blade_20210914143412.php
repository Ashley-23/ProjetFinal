                            ...
                            <form  action="{{route('vue_superadmin_addparent')}}" method="POST">
                                ...
                                <div class="row">
                                  ...
                                  {{-- Pour ajouter la classe --}}
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Selectionner les enfants </label>
                                        <select class="select2" name="EleveParent">
                                            <option value="">Selectionnez vos enfants</option>
                                            @forelse ($eleve as $eleve)
                                                <option value="{{ $eleve->idClasse }}">{{ $classe->nomClasse }} {{ $classe->typeClasse }}</option>
                                                @empty
                                        ...
                                        <p>
                                            Si avez le champ "Veuillez ajouter un élève" <br>
                                            Celà signifie que vous n'avez ajouter aucun élève <br>
                                            dans votre base de donnée 😊😊😊
                                        </p>
                                        {!! $errors->first('Eleve','<span class="error">:message </span>') !!}
