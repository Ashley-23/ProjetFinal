...
<div class="dashboard-content-one">
 ...
 @forelse ($parent as $parent)
                         ...
                         <tr> 
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->i) }} "> {{ $parent->nomEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->i) }} "> {{ $parent->prenomEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->i) }} "> {{ $parent->login }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->i) }} "> {{ $parent->dateNaissEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->i) }} "> {{ $parent->sexeEleve }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->i) }} "> {{ $parent->emailEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->i) }} "> {{ $parent->telephoneEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->i) }} "> {{ $parent->adresseEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$parent->i) }} "> {{ $parent->activeEleve }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
