    ...
    <div class="card height-auto">
        <div class="card-body">
            ...
            <div class="ui-btn-wrap">
                <ul>
                    <a href="{{route('vue_superadmin_addparentaff')}}"> <li><button type="button" class="btn-fill-md radius-4 text-light bg-light-sea-green">Ajouter un parent </button></li> </a>
...
{{-- 
 ...
 @forelse ($parent as $parent)
                         ...
                         <tr> 
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailparent',$parent->idRelative) }} "> {{ $parent->nomRelative }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailparent',$parent->idRelative) }} "> {{ $parent->prenomRelative }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailparent',$parent->idRelative) }} "> {{ $parent->login }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailparent',$parent->idRelative) }} "> {{ $parent->dateNaissRelative }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailparent',$parent->idRelative) }} "> {{ $parent->sexeRelative }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailparent',$parent->idRelative) }} "> {{ $parent->emailRelative }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailparent',$parent->idRelative) }} "> {{ $parent->telephoneRelative }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailparent',$parent->idRelative) }} "> {{ $parent->adresseRelative }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailparent',$parent->idRelative) }} "> {{ $parent->activeRelative }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            {{-- <a class="dropdown-item" href="#"><i
                                                                    class="fas fa-times text-orange-red"></i>Close</a> --}}
                                                            <a class="dropdown-item" href="{{ route('vue_superadmin_updateparentaff',$parent->idRelative) }}"><i
                                                                    class="fas fa-cogs text-dark-pastel-green"></i>Edit</a>
                                                            <a class="dropdown-item" onClick="history.go(0)" href="#"><i
                                                                    class="fas fa-redo-alt text-orange-peel" ></i>Refresh</a>
                                                        </div>
                            ...
                            @empty
                                <div class="ui-alart-box">
                                        <div class="alert icon-alart bg-pink2" role="alert">
                                           ...
                                           AUCUN PARENT DANS LA BASE DE DONNEE
                                        </div>
                                </div>
