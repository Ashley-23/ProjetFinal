...
<div class="dashboard-content-one">
 ...
 @forelse ($prof as $prof)
                         ...
                         <tr> 
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idProfesseur) }} "> {{ $prof->nomProfesseur }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idProfesseur) }} "> {{ $prof->prenomProfesseur }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idProfesseur) }} "> {{ $prof->login }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idProfesseur) }} "> {{ $prof->dateNaissProfesseur }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idProfesseur) }} "> {{ $prof->sexeProfesseur }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idProfesseur) }} "> {{ $prof->emailProfesseur }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idProfesseur) }} "> {{ $prof->telephoneProfesseur }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idProfesseur) }} "> {{ $prof->adresseProfesseur }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idProfesseur) }} "> {{ $prof->activeProfesseur }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            {{-- <a class="dropdown-item" href="#"><i
                                                                    class="fas fa-times text-orange-red"></i>Close</a> --}}
                                                            <a class="dropdown-item" href="{{ route('vue_superadmin_updateeleveaff',$prof->idProfesseur) }}"><i
                                                                    class="fas fa-cogs text-dark-pastel-green"></i>Edit</a>
                                                            <a class="dropdown-item" onClick="history.go(0)" href="#"><i
                                                                    class="fas fa-redo-alt text-orange-peel" ></i>Refresh</a>
                                                        </div>
                            ...
                            @empty
                                <div class="ui-alart-box">
                                        <div class="alert icon-alart bg-pink2" role="alert">
                                           ...
                                           AUCUN PROFESSEUR DANS LA BASE DE DONNEE
                                        </div>
                                </div>
