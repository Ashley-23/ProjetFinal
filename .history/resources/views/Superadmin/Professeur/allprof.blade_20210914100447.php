...
<div class="dashboard-content-one">
 ...
 @forelse ($prof as $prof)
                         ...
                         <tr> 
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->nomEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->prenomEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->login }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->dateNaissEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->sexeEleve }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->emailEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->telephoneEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->adresseEleve }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->activeEleve }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
