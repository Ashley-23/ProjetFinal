...
<div class="dashboard-content-one">
 ...
 @forelse ($prof as $prof)
                         ...
                         <tr> 
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->nomProfesseur }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->prenomProfesseur }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->login }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->dateNaissProfesseur }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->sexeProfesseur }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->emailProfesseur }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->telephoneProfesseur }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->adresseProfesseur }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->activeProfesseur }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
