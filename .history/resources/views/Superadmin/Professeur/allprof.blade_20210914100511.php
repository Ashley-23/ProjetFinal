...
<div class="dashboard-content-one">
 ...
 @forelse ($prof as $prof)
                         ...
                         <tr> 
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->nom }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->prenom }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->login }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->dateNaiss }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->sexe }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->email }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->telephone }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->adresse }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailprof',$prof->idEleve) }} "> {{ $prof->active }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
