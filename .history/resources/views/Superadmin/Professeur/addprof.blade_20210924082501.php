            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                        <div class="card-body">
                            ...
                            <form  action="{{route('vue_superadmin_addprof')}}" method="POST">
                                    {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Nom </label>
                                        <input type="text" placeholder="" class="form-control" name="nomProfesseur">
                                        {!! $errors->first('nomProfesseur','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Prenom </label>
                                        <input type="text" placeholder="" class="form-control" name="prenomProfesseur">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        ...
                                        <input type="date" placeholder="" class="form-control" name="dateNaissProfesseur">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>E-mail</label>
                                        <input type="email" placeholder="" class="form-control" name="emailProfesseur">
                                         {!! $errors->first('emailProfesseur','<span class="error">:message </span>') !!}
                                    </div>

                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Mot de passse </label>
                                        <input type="password" placeholder="" class="form-control" name="passwordProfesseur">
                                        {!! $errors->first('passwordProfesseur','<span class="error">:message </span>') !!}
                                    </div>     
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Telephone</label>
                                        <input type="tel" placeholder="" class="form-control"  name="telephoneProfesseur">
                                        {!! $errors->first('telephoneProfesseur','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Adresse</label>
                                        <input type="text" placeholder="" class="form-control"  name="adresseProfesseur">
