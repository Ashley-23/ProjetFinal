                ...
                <form  action="{{route('vue_superadmin_addmatiere')}}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            <label>Nom </label>
                            <input type="text" placeholder="" class="form-control" name="nomMatieret">
                        ...
                        <div class="col-12 form-group mg-t-8">
                            ...
                            <a href="{{route('vue_superadmin_all <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Nom </label>
                                    ...
                                    </div>')}}"><button type="button" class="btn-fill-lmd radius-4 text-light bg-true-v"> Voir la liste</button></a>
