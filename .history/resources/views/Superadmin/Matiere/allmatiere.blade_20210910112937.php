 ...
 @forelse ($matiere as $matiere)
                         ...
                         <tr> 
                                  ...
                                  <td>
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailclasse',$matiere->idMatiere) }} "> {{ $matiere->typeClasse }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailclasse',$matiere->idMatiere) }} "> {{ $matiere->activeClasse }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
