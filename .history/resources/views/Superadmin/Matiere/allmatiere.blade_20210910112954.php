 ...
 @forelse ($matiere as $matiere)
                         ...
                         <tr> 
                                  ...
                                  <td>
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailmatiere',$matiere->idMatiere) }} "> {{ $matiere->nomClasse }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailMatiere',$matiere->idMatiere) }} "> {{ $matiere->typeClasse }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailMatiere',$matiere->idMatiere) }} "> {{ $matiere->activeClasse }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            {{-- <a class="dropdown-item" href="#"><i
                                                                    class="fas fa-times text-orange-red"></i>Close</a> --}}
                                                            <a class="dropdown-item" href="{{ route('vue_superadmin_updateclasseaff',$matiere->idMatiere) }}"><i
                                                                    class="fas fa-cogs text-dark-pastel-green"></i>Edit</a>
                                                            <a class="dropdown-item" onClick="history.go(0)" href="#"><i
                                                                    class="fas fa-redo-alt text-orange-peel" ></i>Refresh</a>
                                                        </div>
