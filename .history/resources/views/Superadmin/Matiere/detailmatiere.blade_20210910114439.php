    ...
    <div class="card height-auto">
        <div class="card-body">
            <div class="heading-layout1">
                <div class="item-title">
                    <h3>A Propos de :  {{ $matieredetail->nomClasse }} </h3>
                </div>
               <div class="dropdown">
            ...
            <div class="single-info-details">
                <div class="item-content">
                    <div class="header-inline item-header">
                        <h3 class="text-dark-medium font-medium"> {{ $matieredetail->nomClasse }} </h3>
                    ...
                    <div class="info-table table-responsive">
                        ...
                        <table class="table text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Nom:</td>
                                    <td class="font-medium text-dark-medium"> {{ $matieredetail->nomClasse }} </td>
                                </tr>
                                <tr>
                                    <td>Login:</td>
                                    <td class="font-medium text-dark-medium"> {{ $matieredetail->typeClasse }} </td>
                                </tr>
                                <td>Active:</td>
                                    <td class="font-medium text-dark-medium"> {{ $matieredetail->activeClasse }} </td>
                                </tr>
                                <tr>
                                    <td>Crée le :</td>
