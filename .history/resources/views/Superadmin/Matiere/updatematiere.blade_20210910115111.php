                ...
                <div class="card height-auto">
                    {{-- <form action="{{route('vue_superadmin_updateetablissement')}}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <form  action="{{route('vue_superadmin_updateclasse',$matiereedit->idClasse)}}" method="POST">
                                <input type="hidden" name="method" value="PUT">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            ...
                                            <input type="text"  placeholder="{{$matiereedit->nomClasse}}"   class="form-control" name="">
                                        </div>
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Ancienne valeur du type </label>
                                            <input type="text"   placeholder="{{$matiereedit->typeClasse}}"  class="form-control" name="">
                                        </div>
                                    </div>
                                <div class="row">
                                    ...
                                    {{-- <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Nom </label>
                                        <input type="text"   value="{{old('nomClasse') ?? $matiereedit->nomClasse}}" class="form-control" name="nomClasse">
