            ...
            <form class="mg-b-20">
                <div class="row gutters-8">
                    <div class="col-3-xxxl col-xl-3 col-lg-3 col-12 form-group">
                        <input type="text" placeholder="Rechercher par nom ..." class="form-control"> {{--q comme query--}}
                    </div>
                    <div class="col-4-xxxl col-xl-4 col-lg-3 col-12 form-group">
                        <input type="text" placeholder="Rechercher par login ..." > {{--q comme query--}}
                    </div>
                    <div class="col-4-xxxl col-xl-3 col-lg-3 col-12 form-group">
                        <input type="text" placeholder="Rechercher par e-mail ..." class="form-control" > {{--q comme query--}}
                    </div>
