...
{{-- 
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        ...
                                        <input type="text"  placeholder="{{ $classe->nomClasse }} {{ $classe->typeClasse }}" class="form-control"  name="nom" disabled>
                                    </div> --}}
                                     ...
                                     <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        ...
                                        <select class="select2" name="classeEleve">
                                            <option value="">{{old('nomClasse','typeClasse') ??$Classe->nomClasse $classe->typeClasse}}</option>
