                                                                ...
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <a class="dropdown-item" href="{{route('vue_superadmin_supprimerEleve',$eleve->idEleve)}}"></i> <button type="button" class="footer-btn bg-dark-low"
                                                                                >Supprimer</button>Supprimer </a> 
