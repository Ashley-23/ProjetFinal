    ...
    <div class="card height-auto">
        <div class="card-body">
            ...
            <div class="ui-btn-wrap">
                <ul>
                    <a href="{{route('vue_superadmin_addeleveaff')}}"> <li><button type="button" class="btn-fill-md radius-4 text-light bg-light-sea-green">Ajouter un etablissement </button></li> </a>
                ...
                <table class="table display data-table text-nowrap">
                    <thead>
                        <tr>
                            ...
                            <th>Sexe</th>
                            <th>E-mail</th>
                            <th>Mot de passe</th><th>Telephone</th>
                            <th>Adresse </th>
 ...
 @forelse ($etablissement as $etablissement)
                         ...
                         <tr> 
                                  ...
                                  <td>
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$etablissement->idEtablissement) }} "> {{ $etablissement->emailEtablissement }} </a> </td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            {{-- <a class="dropdown-item" href="#"><i
                                                                    class="fas fa-times text-orange-red"></i>Close</a> --}}
                                                            <a class="dropdown-item" href="{{ route('vue_superadmin_updateetablissementaff',$etablissement->idEtablissement) }}"><i
                                                                    class="fas fa-cogs text-dark-pastel-green"></i>Edit</a>
                                                            <a class="dropdown-item" onClick="history.go(0)" href="#"><i
                                                                    class="fas fa-redo-alt text-orange-peel" ></i>Refresh</a>
                                                        </div>
