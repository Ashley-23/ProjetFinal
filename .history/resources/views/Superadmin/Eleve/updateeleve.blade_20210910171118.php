                            ...
                            <form  action="{{route('vue_superadmin_updateeleve',$eleveedit->idEleve)}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Nom </label>
                                        <input type="text"   value="{{old('nomEtablissement') ?? $eleveedit->nomEtablissement}}" class="form-control" name="nomEtablissement">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Adresse</label>
                                        <input type="text"  value="{{old('adresseEtablissement') ??$eleveedit->adresseEtablissement}}" class="form-control" name="adresseEtablissement">
                                         {!! $errors->first('adresseEtablissement','<span class="error">:message </span>') !!}
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>E-mail</label>
                                        <input type="email"   value="{{old('emailEtablissement') ?? $eleveedit->emailEtablissement}}" class="form-control" name="emailEtablissement">
                                         {!! $errors->first('emailEtablissement','<span class="error">:message </span>') !!}
                                    </div>   
                                    {{-- value="{{$eleveedit->emailEtablissement}}" --}}
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Telephone</label>
                                        <input type="tel"  value="{{old('telephoneEtablissement') ??$eleveedit->telephoneEtablissement}}" class="form-control"  name="telephoneEtablissement">
