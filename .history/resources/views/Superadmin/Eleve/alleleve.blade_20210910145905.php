 ...
 @forelse ($eleve as $eleve)
                         ...
                         <tr> 
                                  ...
                                  <td>
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$eleve->idEtablissement) }} "> {{ $eleve->nomEtablissement }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$eleve->idEtablissement) }} "> {{ $eleve->login }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$eleve->idEtablissement) }} "> {{ $eleve->adresseEtablissement }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$eleve->idEtablissement) }} "> {{ $eleve->emailEtablissement }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$eleve->idEtablissement) }} "> {{ $eleve->password }} </a>  </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailetablissement',$eleve->idEtablissement) }} "> {{ $eleve->telephoneEtablissement }} </a> </td>
