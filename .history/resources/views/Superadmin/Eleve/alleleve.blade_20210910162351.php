                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu sub-group-active">
                                <li class="nav-item">
                                    <a href="{{route('vue_superadmin_alleleve') }}" class="nav-linkmenu-active"><i class="fas fa-angle-right"></i>
                                        Inscription</a>
                                </li>
                                <li class="nav-item">
...
<div class="dashboard-content-one">
 ...
 @forelse ($eleve as $eleve)
                         ...
                         <tr> 
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detaileleve',$eleve->idEleve) }} "> {{ $eleve->passwordEleve }} </a> </td>
