                                                ...
                                                <td>
                                                      {{-- <div class="ui-modal-box"> --}}
                                                            {{-- <div class="modal-box"> --}}
                                                                ...
                                                                <button type="button" class="deleteEleve" data-url="" data-id="{{ $eleve->idEleve }}" data-nom="{{ $eleve->nomEleve }}" data-prenom="{{ $eleve->prenomEleve }}" data-toggle="modal"
                                                               > 
...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            Voulez vous supprimer {{ $eleve->nomEleve }} {{ $eleve->prenomEleve }} ?
        </div>
...
<script>
    ...
    $(".deleteEleve").click(function () {
        var idEleve=  $(".deleteEleve").attr("data-id");
        var nomEleve= $(".deleteEleve").attr("data-nom");
        var prenomEleve=  $(".deleteEleve").attr("data-prenom");
        alert(idEleve)
