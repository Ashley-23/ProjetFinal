                        ...
                        <div class="card-body">
                            ...
                            <form  action="{{route('vue_superadmin_updateeleve',$eleveedit->idEleve)}}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Genre</label>
                                        @if ($editEleve->sexeEleve=='m')
                                        <input type="text"  value="{{old('sexeEleve') ?? $eleveedit->sexeEleve}}" class="form-control" name="sexeEleve" disabled>
                                        @elseif($editEleve->sexeEleve=='f')
