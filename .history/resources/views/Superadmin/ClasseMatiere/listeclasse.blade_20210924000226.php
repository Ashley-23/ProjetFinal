                ...
                <ul class="navbar-nav">
                    ...
                    <li class="navbar-item dropdown header-admin">
                        <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                            ...
                            <div class="admin-img">
                                <img src="img/figure/admin" alt="Admin">
                            </div>.jpg
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="item-header">
...
<div class="dashboard-content-one">
    ...
    <div class="breadcrumbs-area">
        ...
        <ul>
            ...
            <li>Liste des matières par classe</li>
        </ul>
        <ul>
                                        ...
                                        <table class="table text-nowrap">
                                            <tbody>
                                                <div class="ui-btn-wrap">
                                                    <ul>
                                                        <a href="{{route('vue_superadmin_addcmaff')}}"> <li><button type="button" class="btn-fill-md radius-4 text-light bg-light-sea-green">Associer une classe à une matiere </button></li> </a>
                                                        
                                                    </ul>
                                                </div>
                                                @forelse ($listeclasse as $listeclasse ) 
                                                    <tr>
                                                        {{-- <td align="center "> <a href="{{route('vue_superadmin_listeclasse',$matiere->idMatiere)}}"> {{$matiere->nomMatiere}} </a> </td> --}}
                                                        <td align="center" > <a href="{{route('vue_superadmin_listeeleve',['idclasse'=>$listeclasse->idClasse,'idmatiere'=>$listeclasse->idMatiere])}}"> {{$listeclasse->nomClasse}} {{$listeclasse->typeClasse}} </a></td>
                                                        {{-- <td align="center" > {{$listeclasse->Classe_Matieres->id}} </a></td> --}}
                                                        {{-- {{route('post.show',['id'=>$post->id,'name'=>$post->title])} --}}
                                                    </tr>
                                                @empty
