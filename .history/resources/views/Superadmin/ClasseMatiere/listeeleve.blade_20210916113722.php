        ...
        <div class="card-body">
            ...
            <div class="ui-btn-wrap">
                <ul>
                    ...
                    <a href="{{route('vue_superadmin_listenote',$ridcm->id)}}"> <li><button type="button" class="btn-fill-md radius-4 text-light bg-light-sea-green">Liste des notes  </button></li> </a>
