...
<style>
 ...
 <div class="dashboard-content-one">
    ...
    <div class="breadcrumbs-area">
        <h3>Classe et matieres</h3>
        <ul>
            <li>
                <a href="{{route('vue_superadmin_accueil')}}">Home</a>
            </li>
            <li>Affecté une matiere à une classe</li>
        </ul>
    ...
    <div class="card height-auto">
        <form action="{{route('vue_superadmin_addcm')}}" method="POST">
            {{ csrf_field() }}
            <div class="card-body">
                <div class="heading-layout1">
                    <div class="item-title">
                        <h3>Affecté une matiere à une classe</h3>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            <div class="ui-btn-wrap">
                                <ul>
                                    <a href="{{route('vue_superadmin_addclasseaff')}}"> <li><button type="button" class="btn-fill-md radius-4 text-light bg-light-sea-green">Ajouter une classe </button></li> </a>
                        ...
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            ...
                            <label>Matiere</label>
                            <select class="select2" name="matiereEleve">
                                ...
                                @forelse ($matiere as $matiere)
                                    ...
                                    @empty
                                    <option value="">Veuillez ajouter une matiere</option>
                                @endforelse
                            </select>
                             {!! $errors->first('matiereEleve','<span class="error">:message </span>') !!}
                            <p>
                                Si avez le champ "Veuillez ajouter une matiere" <br>
                                Celà signifie que vous n'avez ajouter aucune matiere <br>
                                dans votre base de donnée 😊😊😊
                            </p>
                        ...
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            <div class="ui-btn-wrap">
                                <ul>
                                    <a href="{{route('vue_superadmin_addprofaff')}}"> <li><button type="button" class="btn-fill-md radius-4 text-light bg-light-sea-green">Ajouter un professeur </button></li> </a>
                                    
                                </ul>
                            </div>
                            <label>Professeur</label>
                            <select class="select2" name="nomProfesseur">
                                <option value="">Nom du professeur</option>
                                @forelse ($professeur as $professeur)
                                    <option value="{{ $professeur->idProfesseur }}">{{ $professeur->nomProfesseur }} {{ $professeur->prenomProfesseur }} </option>
                                    @empty
                                    <option value="">Veuillez ajouter un professeur</option>
                                @endforelse
                            </select>
                             {!! $errors->first('nomProfesseur','<span class="error">:message </span>') !!}
                            <p>
                                Si avez le champ "Veuillez ajouter un professeur" <br>
                                Celà signifie que vous n'avez ajouter aucun professeur <br>
                                dans votre base de donnée 😊😊😊
                            </p>
                        ...
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            ...
                            <input type="number" value="{{$cm->coef}}" min="0" name="coef">
                             {!! $errors->first('coe','<span class="error">:message </span>') !!}
                        ...
                        <div class="col-12 form-group mg-t-8">
                            ...
                            <a href="{{route('vue_superadmin_allcm')}}"><button type="button" class="btn-fill-lmd radius-4 text-light bg-true-v"> Voir la liste</button></a>
