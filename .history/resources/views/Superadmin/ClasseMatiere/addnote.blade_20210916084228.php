                                       ...
                                       <div class="row">
                                        ...
                                        <tr>
                                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                                ...
                                                <td><input type="email"   value="{{ $eleveaff->emailEleve}}" class="form-control" name="emailEleve"></td>
                                    ...
                                    <tr>
                                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                               <td><label>Telephone</label></td>
                                                <td><input type="tel"  value="{{?$eleveaff->telephoneEleve}}" class="form-control"  name="telephoneEleve"></td>
