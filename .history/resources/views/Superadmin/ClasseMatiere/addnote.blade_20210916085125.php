                        ...
                        <input type="hidden" name="method" value="PUT">
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Note </label>
                                    <input type="text"   value="" class="form-control" name="nomEleve">
                                    {!! $errors->first('nomEleve','<span class="error">:message </span>') !!}
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Note </label>
                                    <input type="text"   value="{{old(" class="form-control" name="prenomEleve">
                                    {!! $errors->first('prenomEleve','<span class="error">:message </span>') !!}
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Note</label>
                                    <input type="text"  v" class="form-control" name="login">
