                                            ...
                                            <tbody>
                                                @forelse ($listeclasse as $listeclasse ) 
                                                    <tr>
                                                        ...
                                                        <td align="center" > <a href="{{route('vue_superadmin_listeeleve',['id$listeclasse->idClasse,$listeclasse->idMatiere])}}"> {{$listeclasse->nomClasse}} {{$listeclasse->typeClasse}} </a></td>
