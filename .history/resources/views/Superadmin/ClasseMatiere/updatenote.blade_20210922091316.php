        ...
        <ul>
            ...
            <div class="card height-auto">
                <div class="card-body">
                    ...
                    {{-- <a href="{{route('vue_superadmin_addnoteaff',['idclasse'=>$listeeleve->idClasse,'idmatiere'=>$listeeleve->idMatiere,'ideleve'=>$listeeleve->idEleve]) }}"> --}}
                    <form  action="{{route('vue_superadmin_updatenote',[ 'idnote'=>$noteedit->idNote,'idcm'=>$noteedit->id ] ) }}" method="POST">
                        <input type="hidden" name="method" value="PUT">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>idnote </label>
                                    <input type="text"  value="{{$noteedit->id}}" class="form-control" name="id">
                                </div>
                            </div>
