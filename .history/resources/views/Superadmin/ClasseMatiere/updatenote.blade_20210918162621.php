                        ...
                        <input type="hidden" name="method" value="PUT">
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label> Note 1 </label>
                                    <input type="number"   value="{{old('note1') ?? $eleveaff->noteeleve}}"  class="form-control" name="note1" min="0" max="20" step="0.25">
                                    {!! $errors->first('note1','<span class="error">:message </span>') !!}
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label> Note 2 </label>
                                    <input type="number"  value="{{old('note2') ?? $eleveaff->nomEleve}}"  class="form-control" name="note2" min="0" max="20" step="0.25">
                                    {!! $errors->first('note2','<span class="error">:message </span>') !!}
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label> Note 3 </label>
                                    <input type="number"   value="{{old('note3') ?? $eleveaff->nomEleve}}"   class="form-control" name="note3" min="0" max="20" step="0.25">
