...
<div class="dashboard-content-one">
    ...
    <div class="breadcrumbs-area">
        <h3>Liste des casses par matiere</h3>
        <ul>
            <li>
                <a href="index-2.html">Home</a>
            </li>
            <li>Liste des casses par matiere</li>
        </ul>
        <ul>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-6">
                                <div class="item-content">
                                    ...
                                    <div class="item-number"><span class="counter" data-num=" {{ $matiere->count() }} "> {{ $cm->count() }} </span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-sm-6 col-12">
                    <div class="dashboard-summery-one mg-b-20">
                        <div class="row align-items-center">
                            ...
                            <div class="col-6">
                                <div class="item-content">
                                    <div class="item-title">Classe </div>
                                    <div class="item-number"><span class="counter" data-num=" {{ $cm->count() }} "> {{ $cm->count() }} </span></div>
                                </div>
                            </div>
                        </div>
                    </div>
 ...
 @forelse ($classe as $classe)
                         ...
                         <tr> 
                                  ...
                                  <td>
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailclasse',$classe->idClasse) }} "> {{ $classe->nomClasse }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailclasse',$classe->idClasse) }} "> {{ $classe->typeClasse }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailclasse',$classe->idClasse) }} "> {{ $classe->activeClasse }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            {{-- <a class="dropdown-item" href="#"><i
                                                                    class="fas fa-times text-orange-red"></i>Close</a> --}}
                                                            <a class="dropdown-item" href="{{ route('vue_superadmin_updateclasseaff',$classe->idClasse) }}"><i
                                                                    class="fas fa-cogs text-dark-pastel-green"></i>Edit</a>
                                                            <a class="dropdown-item" onClick="history.go(0)" href="#"><i
                                                                    class="fas fa-redo-alt text-orange-peel" ></i>Refresh</a>
                                                        </div>
                            ...
                            @empty
                                <div class="ui-alart-box">
                                        <div class="alert icon-alart bg-pink2" role="alert">
                                           ...
                                           AUCUNE CLASSE DANS LA BASE DE DONNEE
                                        </div>
                                </div>
