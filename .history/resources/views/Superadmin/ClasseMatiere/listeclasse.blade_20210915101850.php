                                            ...
                                            <tbody>
                                                @forelse ($listeclasse as $listeclasse ) 
                                                    <tr>
                                                        ...
                                                        <td align="center" > <a href="{{route('vue_superadmin_listeeleve',$listeclasse->idClasse)}}"> {{$listeclasse->nomClasse}} {{$listeclasse->typeClasse}} </a></td>
                                                        
                                                        <td align="center"> {{$listeclasse->nomClasse}} {{$listeclasse->typeClasse}} </a></td>
                                                    </tr>
                                                @empty
