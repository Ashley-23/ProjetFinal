                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu sub-group-active">
                                ...
                                <li class="nav-item">
                                    <a href="{{route('vue_superadmin_allclasse')}}" class="nav-link "><i class="fas fa-angle-right"></i>Etablissement
                                        </a>
                                </li>
                                <li class="nav-item">
...
<div class="dashboard-content-one">
                                ...
                                <div class="heading-layout1">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item" href="#" onClick="history.go(0)" ><i
                                                            ...
                                                            @forelse ($classe as $classe )
                                                                <tr>
                                                                  {{-- <a href="{{route('vue_superadmin_listematiere',$classe->idClasse)}}">  </a> 
                                                                    ...
                                                                    <td align="center "> <a href="{{route('vue_superadmin_listeclasse',$matiere->idMatiere)}}"> {{$classe->nomClasse}} {{$classe->typeClasse}} </a> </td>
                                                                </tr>
                                                            @empty
                                                                <span> Aucune matiere dans la base de donnée </span>
                                                                <div class="ui-btn-wrap">
                                                                    <ul>
                                                                        <a href="{{route('vue_superadmin_addmatiereaff')}}"> <li><button type="button" class="btn-fill-md radius-4 text-light bg-light-sea-green">Ajouter une classe </button></li> </a>
    ...
    <div class="card height-auto">
        <div class="card-body">
            <div class="heading-layout1">
                <div class="item-title">
                    <h3>Liste des matières par classe </h3>
                </div>
                            ...
                            @forelse ($cm as $cm)
                                ...
                                <tr> 
                                        ...
                                        <td>
                                                        ...
                                                        {{-- <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $all->$classe->nomClasse }} </a> </td> --}}
                                                        <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $cm->idMatiere }} </a> </td>
                                                        {{-- <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $all->$matiere->nomMatiere }} </a> </td> --}}
                                                        <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $cm->idProfesseur }} </a> </td>
                                                        {{-- <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $all->$prof->nomProfesseur }} </a> </td> --}}
                                                        <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $cm->active }} </a> </td>
                                                        <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $cm->created_at }} </a> </td>
                                                        <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $cm->updated_at }} </a> </td>
                                                        <td>
                                                            <div class="dropdown">
