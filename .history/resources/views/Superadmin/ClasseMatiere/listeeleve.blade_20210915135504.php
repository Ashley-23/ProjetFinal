                                ...
                                <table class="table text-nowrap">
                                    ...
                                    <tbody>
                                        @forelse ($listeeleve as $listeeleve )
                                            <tr>
                                                <td > <a href="{{route('vue_superadmin_addnoteaff',['idclasse'=>$listeeleve->idClasse,'idmatiere'=>$listeclasse->idMatiere])}}"> {{$listeeleve->nomEleve}} {{$listeeleve->prenomEleve}}</a> </td>
