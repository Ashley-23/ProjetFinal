 ...
 @forelse ($cm as $cm)
                         ...
                         <tr> 
                                  ...
                                  <td>
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $c->idClasse }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $c->nomClasse }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $c->idMatiere }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $c->nomMatiere }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $c->active }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $c->created_at }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $c->updated_at }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
