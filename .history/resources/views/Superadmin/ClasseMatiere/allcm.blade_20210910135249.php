 ...
 @forelse ($cm as $cm)
                         ...
                         <tr> 
                                  ...
                                  <td>
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailcm',$classe->idClasse) }} "> {{ $classe->typeClasse }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailcm',$classe->idClasse) }} "> {{ $classe->activeClasse }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
