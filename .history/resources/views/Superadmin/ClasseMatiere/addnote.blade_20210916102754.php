                        ...
                        <input type="hidden" name="method" value="PUT">
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label> Note 1 </label>
                                    <input type="text"  placeholder="12.50" value="" class="form-control" name="note1">
                                    {!! $errors->first('note1','<span class="error">:message </span>') !!}
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label> Note 2 </label>
                                    <input type="text" placeholder="12.50"  value="" class="form-control" name="note2">
                                    {!! $errors->first('note2','<span class="error">:message </span>') !!}
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label> Note 3 </label>
                                    <input type="text"  placeholder="12.50" class="form-control" name="note3">
                                    {!! $errors->first('note3','<span class="error">:message </span>') !!}
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label> </label>
                                    <input type="text"  value="{{$eleveaff->idEleve}}" class="form-control" name="idEleve">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label> </label>
                                    <input type="text"  value="{{$idcmaff->id}}" class="form-control" name="id">
                                </div>
