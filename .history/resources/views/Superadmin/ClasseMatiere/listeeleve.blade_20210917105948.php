    ...
    <div class="card height-auto">
        <div class="card-body">
            <div class="heading-layout1">
                <div class="item-title">
                    <h3>Affecter des notes aux élèves   </h3>
                </div>
            ...
            <div class="ui-btn-wrap">
                <ul>
                    <a href="{{route('vue_superadmin_addeleveaff')}}"> <li><button type="button" class="btn-fill-md radius-4 text-light bg-light-sea-green">Ajouter un élève </button></li> </a>
                   @if ($e>0 && $l>0)
                       
                    <a href="{{route('vue_superadmin_allnote',$ridcm->id)}}"> <li><button type="button" class="btn-fill-md radius-4 text-light bg-light-sea-green">Liste des notes  </button></li> </a>
                                ...
                                <table class="table text-nowrap">
                                    ...
                                    <tbody>
                                        @forelse ($listeeleve as $listeeleve )
                                            <tr>
                                                <td > <a href="{{route('vue_superadmin_addnoteaff',['idclasse'=>$listeeleve->idClasse,'idmatiere'=>$listeeleve->idMatiere,'ideleve'=>$listeeleve->idEleve]) }}"> {{$listeeleve->nomEleve}} {{$listeeleve->prenomEleve}}</a> </td>
                                                <td> {{ $listeeleve->nomClasse }} {{$listeeleve->typeClasse}} </td>
                                            </tr>
                                        @empty
                                            <span> Veuillez ajouter des élèves dans la classe de  </span>
                                        @endforelse
                                        {{-- {{route('vue_superadmin_listeeleve',$listeeleve->idEleve,)}} --}}
