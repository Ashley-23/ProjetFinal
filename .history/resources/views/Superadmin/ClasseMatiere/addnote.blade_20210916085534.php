                        ...
                        <input type="hidden" name="method" value="PUT">
                            ...
                            <table>
                                         ...
                                         <tr>
                                             ...
                                             <td> <input type="text"   value="{{ $eleveaff->nomEleve}}" class="form-control" name="nomEleve" disabled></td>
                                        </tr>
                                        <tr>
                                            
                                            <td> <label>Prenom </label></td>
                                            <td>  <input type="text"   value="{{ $eleveaff->prenomEleve}}" class="form-control" name="prenomEleve" disabled></td>
                                        
                                        </tr>
                                        <tr>
                                            
                                            <td>  <label>Login</label> </td>
                                            <td> <input type="text"  value="{{ $eleveaff->login}}" class="form-control" name="login" disabled> </td>
                                        
                                        </tr>
                                        <tr>
                                            
                                            <td> <label>Date de naissance</label></td>
                                            <td> <input type="date"  value="{{$eleveaff->dateNaissEleve}}" class="form-control" name="dateNaissEleve" disabled></td>
                                        ...
                                        <tr>
                                                ...
                                                <td>Adresse</td>
                                                <td><input type="text"  value="{{$eleveaff->adresseEleve}}" class="form-control" name="adresseEleve" disabled></td>
                                        
                                        </tr>
                                        <tr>
                                            
                                                <td><label>E-mail</label></td>
                                                <td> <input type="email"   value="{{ $eleveaff->emailEleve}}" class="form-control" name="emailEleve" disabled> </td>
                                              
                                        </tr>
                                        <tr>
                                            
                                               <td><label>Telephone</label></td>
                                                <td><input type="tel"  value="{{$eleveaff->telephoneEleve}}" class="form-control"  name="telephoneEleve" disabled></td>
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label> Note 1 </label>
                                    <input type="text"  placeholder="12.50" value="" class="form-control" name="nomEleve">
                                    {!! $errors->first('nomEleve','<span class="error">:message </span>') !!}
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label> Note 2 </label>
                                    <input type="text" placeholder="12.50"  value="" class="form-control" name="prenomEleve">
                                    {!! $errors->first('prenomEleve','<span class="error">:message </span>') !!}
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label> Note 3 </label>
                                    <input type="text"  placeholder="12.50" class="form-control" name="login">
