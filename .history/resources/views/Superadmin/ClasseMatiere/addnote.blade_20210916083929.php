                                ...
                                <tbody>
                                       ...
                                       <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td> <input type="text"  value="{{ $eleveaff->login}}" class="form-control" name="login"> </td>
                                        ...
                                        <tr>
                                            ...
                                            <td> <input type="date"  value="{{$eleveaff->dateNaissEleve}}" class="form-control" name="dateNaissEleve"></td>
                                        ...
                                        <tr>
                                            ...
                                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                                <label>Adresse</label>
                                                <td><input type="text"  value="{{old('adresseEleve') ??$eleveedit->adresseEleve}}" class="form-control" name="adresseEleve"></td>
