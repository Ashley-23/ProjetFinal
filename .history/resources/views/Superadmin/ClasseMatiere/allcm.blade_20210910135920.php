    ...
    <div class="card height-auto">
        <div class="card-body">
            <div class="heading-layout1">
                <div class="item-title">
                    <h3>Liste des matieères par classe </h3>
                </div>
 ...
 @forelse ($cm as $cm)
                         ...
                         <tr> 
                                  ...
                                  <td>
                                                ...
                                                <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $classe->idClasse }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $classe->nomClasse }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $classe->idMatiere }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $classe->nomMatiere }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $classe->active }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $classe->created_at }} </a> </td>
                                                <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $classe->updated_at }} </a> </td>
                                                <td>
                                                    <div class="dropdown">
