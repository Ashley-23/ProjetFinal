                        ...
                        <table class="table display data-table text-nowrap">
                                ...
                                <tr>
                                    <th> 
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label">Compte</label>
                                        </div>
                                    </th>
                                    <th>Nom Eleve</th>
                                    <th>Prenom Eleve</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    {{-- <a href=" {{ route('vue_superadmin_detaileleve',$eleve->idEleve) }} "> {{ $eleve->nomEleve }} </a> --}}
                                    <td ><a href="#"> {{ $listenote->nomEleve}} </a></td>
                                    <td ><a href="#"> {{ $listenote->prenomEleve}} </a></td>
                                    <td ><a href="#"> {{ $listenote->emailEleve}} </a></td>
                                    <td ><a href="#"> {{ $listenote->nomClasse}} </a></td>
                                    <td ><a href="#"> {{ $listenote->nomMatiere}} </a></td>
                                    <td ><a href="#"> {{ $listenote->note1}} </a></td>
                                    <td ><a href="#"> {{ $listenote->note2}} </a></td>
                                    <td ><a href="#"> {{ $listenote->note3}} </a></td>
                                     <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="#"><i class="fas fa-cogs text-dark-pastel-green"></i>Edit</a>
                                                <a class="dropdown-item" href="#" onclick="history.go"><i class="fas fa-redo-alt text-orange-peel"></i>Refresh</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
