...
<div class="dashboard-content-one">
    ...
    <div class="breadcrumbs-area">
        ...
        <ul>
            ...
            <li>Liste des classes par matieres</li>
        </ul>
        <ul>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-6">
                                <div class="item-content">
                                    ...
                                    <div class="item-number"><span class="counter" data-num=" {{ $classe->count() }} "> {{ $matiere->count() }} </span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table class="table text-nowrap">
                                            <tbody>
                                                @forelse ($listeclasse as $listeclasse ) 
                                                    <tr>
                                                        <td align="center" > {{$listeclasse->nomClasse}} {{$listeclasse->typeClasse}}  </td>
                                                    </tr>
                                                @empty
                                                    <span> Aucune classe n'a été associé à la classe dans la base de donnée </span>
                                                @endforelse
