                    ...
                    <form  action="{{route('vue_superadmin_addnote',$eleveaff->idEleve)}}" method="POST">
                        <input type="hidden" name="method" value="PUT">
                            ...
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                <input type="number" placeholder="" class="form-control" name="coef" min="0" max="20" step="0.25">
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label> Note 1 </label>
                                    <input type="number"  placeholder="12.50" value="" class="form-control" name="note1">
                                    {!! $errors->first('note1','<span class="error">:message </span>') !!}
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label> Note 2 </label>
                                    <input type="number" placeholder="12.50"  value="" class="form-control" name="note2">
                                    {!! $errors->first('note2','<span class="error">:message </span>') !!}
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label> Note 3 </label>
                                    <input type="number"  placeholder="12.50" class="form-control" name="note3">
