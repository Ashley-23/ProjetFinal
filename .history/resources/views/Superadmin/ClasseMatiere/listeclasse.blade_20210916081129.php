                                        ...
                                        <table class="table text-nowrap">
                                            <tbody>
                                                <div class="ui-btn-wrap">
                                                    <ul>
                                                        <a href="{{route('vue_superadmin_addcmaff')}}"> <li><button type="button" class="btn-fill-md radius-4 text-light bg-light-sea-green">Associer une classe dans une matiere </button></li> </a>
