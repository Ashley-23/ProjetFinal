                                       ...
                                       <div class="row">
                                         <tr>
                                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                               ...
                                               <td> <input type="text"   value="{{ $eleveaff->nomEleve}}" class="form-control" name="nomEleve"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>  <input type="text"   value="{{old('prenomEleve') ?? $eleveedit->prenomEleve}}" class="form-control" name="prenomEleve"></td></td>
