                                ...
                                <div class="kids-details-box mb-5">
                                    <div class="item-content table-responsive">
                                        <table class="table text-nowrap">
                                            <tbody>
                                                @forelse ($matiereliste as $matiereliste )
                                                    <tr>
                                                       {{-- <td> <a href="{{route('vue_superadmin_listematiere')}}"> clique</a> </td>  --}}
                                                        <td align="center" > {{$matiere->nomMatiere}}  </td>
                                                    </tr>
                                                @empty
                                                    <span> Aucune matiere n'a été associé à la classe {{$classe->nomClasse}} {{$classe->typeClasse}} dans la base de donnée </span>
                                                @endforelse
