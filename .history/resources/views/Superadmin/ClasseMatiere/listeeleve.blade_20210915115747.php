...
<td align="center"> <a href=""> {{$listeeleve->idEleve}} </a> </td>
                                                <td align="center "> <a href="{{route('vue_superadmin_listeclasse',$listeeleve->idEleve)}}"> {{$listeeleve->nomEleve}} {{$listeeleve->prenomEleve}}</a> </td>
                                            </tr>
                                        @empty
