...
<div class="dashboard-content-one">
    ...
    <div class="breadcrumbs-area">
        <h3>Liste des classes par matiere</h3>
        <ul>
            <li>
                <a href="index-2.html">Home</a>
            </li>
            <li>Liste des classes par matiere</li>
        </ul>
        <ul>
                            ...
                            @forelse ($cm as $cm)
                                ...
                                <tr> 
                                        ...
                                        <td>
                                                        ...
                                                        {{-- <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $all->nomClasse }} </a> </td> --}}
                                                        <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $cm->idMatiere }} </a> </td>
                                                        {{-- <td>  <a href=" {{ route('vue_superadmin_detailcm',$cm->id) }} "> {{ $all->nomMatiere }} </a> </td> --}}
