              ...
              <form  action="{{route('loginController')}}">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control form-control-lg border-left-0" id="exampleInputEmail" placeholder="Nom d'utilisateur" name="login">
                  </div>
                  <p>{!! $errors->first('login','<span class="error">:message </span>') !!}</p>
                </div>
                <div class="form-group">
                  ...
                  </div>{!! $errors->first('password','<span class="error">:message </span>') !!}  
                </div>
