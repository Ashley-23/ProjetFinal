...
<body>
          ...
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              ...
              <form class="pt-3">
                ...
                <div class="my-3">
                  <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="{{asset('../../index.html')}}">LOGIN</a>
                </div>
                ...
                <div class="text-center mt-4 font-weight-light">
                  Don't have an account? <a href="{{route('ashleyregister')}}" class="text-primary">Create</a>
                </div>
              </form>
            </div>
          </div>
  ...
  <script src="{{asset('Majs/js/hoverable-collapse.js')}}"></script>
  <script src="{{asset('Majs/js/template.js')}}"></script>
  <!-- endinject -->
</body>
