                ...
                <li class="navbar-item dropdown header-admin">
                    <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                        ...
                        <div class="admin-title">
                            <h5 class="item-title">{{$confirmeconnexionparent->nomRelative}} {{$confirmeconnexionprof->prenomRelative}} </h5>
                            <span>Parent</span>
                        </div>
                        <div class="admin-img">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <div class="item-header">
                            <h6 class="item-title">{{$confirmeconnexionprof->nomRelative}} {{$confirmeconnexionparent->prenomRelative}}</h6>
                        </div>
