...
Route::get('/superadmin_listeeleve/{id}/{idmatiere}', 'SuperAdminAffController@listeeleve')->name('vue_superadmin_listeeleve');

//Pour afficher la liste des notes des élèvesà éditer 
Route::get('/superadmin_addnoteaff/{idClasse}/{idMatiere}', 'SuperAdminAffController@listeeleve')->name('vue_superadmin_addnoteaff');

//Pour editer la note des eleves après click sur un élève 
Route::get('/superadmin_addnote/{id}', 'SuperAdminAffController@listeeleve')->name('vue_superadmin_addnote');
