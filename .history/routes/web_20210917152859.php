...
Route::post('/superadmin_addnote/{id}', 'SuperAdminAffController@addnote')->name('vue_superadmin_addnote');

//Pour afficher la liste'interface de mise à jour 'radmin_addnoteaff/{idclasse}/{idmatiere}/{ideleve}', 'SuperAdminAffController@addnoteaff')->name('vue_superadmin_addnoteaff');

//Pour mettre à jour la note des eleves après click sur un élève 
Route::post('/superadmin_updatenote/{id}', 'SuperAdminAffController@updatenote')->name('vue_superadmin_updatenote');
