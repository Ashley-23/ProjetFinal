...
//     return view('welcome')->name('vue_welcome');
// });   
...
// Route::get('/inscriptioncompte', function () {
...
Route::get('/accueil', 'loginController@affichage')->name('logincontrolleraff');
// Pour gerer les accueils 
Route::get('/accueils', 'loginController@connexion')->name('loginController');

// Pour qu'un parent voit le detail sur les notes de son enfant 
Route::get('/detail_eleve_note/{idParent}/{idEnfant}', 'loginController@detailnote')->name('loginControllerdetailnoteeleve');

Route::get('/dashboardparent/{id}', 'loginController@dashboardparent')->name('dashboardparent');

route::get('/deconnexionutilisateur', 'loginController@deconnexion')->name('deconnexion');
// Appel du controller 
Route::resource('eleveController', EleveController::class);
Route::get('/dashboardeleve', 'EleveController@eleveall')->name('eleve');

// Route::get('/dashboardparent/{id}', 'EleveController@dashboardparent')->name('dashboardparent');
Route::get('/dashboardprofesseur', 'EleveController@dashboardprofesseur')->name('eleve');
Route::get('/dashboardetablissement', 'EleveController@dashboardetablissement')->name('dashboardetablissement');
Route::get('/dashboardadministrateur', 'EleveController@dashboardadministrateur')->name('dashboardadministrateur');

// 
// Route::get('/deconnexion', 'loginController@deconnexion')->name('deconnexionc');
...
// afficher la vue d'ajout des parents 
Route::get('/superadmin_addeleveparentaff/{id}', 'SuperAdminAffController@addeleveparentaff')->name('vue_superadmin_addeleveparentaff');
// Pour mettre à jour le parent d'un élève
Route::post('/superadmin_addeleveparent/{id}', 'SuperAdminAffController@addeleveparent')->name('vue_superadmin_addeleveparent');
// Pour supprimer un eleve
Route::get('/supprimerEleve/{id}', 'SuperAdminAffController@SupprimerEleve')->name('vue_superadmin_supprimerEleve');
