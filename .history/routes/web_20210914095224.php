...
Route::get('/superadmin_allprof', 'SuperAdminAffController@alleleve')->name('vue_superadmin_alleleve');
// Pour afficher la vue d'ajout d'un professeur 
Route::get('/superadmin_addprofaff', 'SuperAdminAffController@addeleveaff')->name('vue_superadmin_addeleveaff');
// Pour ajouter un professeur
Route::post('/superadmin_addprof', 'SuperAdminAffController@addeleve')->name('vue_superadmin_addeleve');
// Pour afficher le detail sur un professeur en particulier  
Route::get('/superadmin_detailprof/{id}', 'SuperAdminAffController@detaileleve')->name('vue_superadmin_detaileleve');
// Pour afficher l'interface de mise à jour d'un professeur
Route::get('/superadmin_updateprofaff/{id}', 'SuperAdminAffController@updateeleveaff')->name('vue_superadmin_updateeleveaff');
// Pour mettre à jour les données d'un professeur
Route::post('/superadmin_updateprof/{id}', 'SuperAdminAffController@updateeleve')->name('vue_superadmin_updateeleve');
