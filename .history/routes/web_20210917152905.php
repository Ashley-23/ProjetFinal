...
//Pour afficher l'interface de mise à jour 'radmin_addnoteaff/{idclasse}/{idmatiere}/{ideleve}', 'SuperAdminAffController@addnoteaff')->name('vue_superadmin_addnoteaff');
