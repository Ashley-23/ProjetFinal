...
//Pour afficher la liste des matières après click sur une classe 
Route::get('/superadmin_listematiere/{id}', 'SuperAdminAffController@listematiere')->name('vue_superadmin_listematiere');
// Pour afficher la liste des etablissements 
...
Route::get('/superadmin_allparent', 'SuperAdminAffController@allparent')->name('vue_superadmin_allprof');
// Pour afficher la vue d'ajout d'un parent 
Route::get('/superadmin_addparentaff', 'SuperAdminAffController@addparentaff')->name('vue_superadmin_addprofaff');
// Pour ajouter un parent
Route::post('/superadmin_addparent', 'SuperAdminAffController@addparent')->name('vue_superadmin_addprof');
// Pour afficher le detail sur un parent en particulier  
Route::get('/superadmin_detailparent/{id}', 'SuperAdminAffController@detailparent')->name('vue_superadmin_detailprof');
// Pour afficher l'interface de mise à jour d'un parent
Route::get('/superadmin_updateparentaff/{id}', 'SuperAdminAffController@updateparentaff')->name('vue_superadmin_updateprofaff');
// Pour mettre à jour les données d'un parent
Route::post('/superadmin_updateparent/{id}', 'SuperAdminAffController@updateparent')->name('vue_superadmin_updateprof');
