...
// Pour ajouter un etablissement
Route::post('/superadmin_addcm', 'SuperAdminAffController@addcm')->name('vue_superadmin_addcme');
// Pour afficher le detail sur un etablissement en particulier  
...
// Pour afficher la liste des etablissements 
Route::get('/superadmin_alleleve', 'SuperAdminAffController@allmatiere')->name('vue_superadmin_allmatiere');
// Pour afficher la vue d'ajout d'un etablissement 
Route::get('/superadmin_addeleveaff', 'SuperAdminAffController@addmatiereaff')->name('vue_superadmin_addmatiereaff');
// Pour ajouter un etablissement
Route::post('/superadmin_addeleve', 'SuperAdminAffController@addmatiere')->name('vue_superadmin_addmatiere');
// Pour afficher le detail sur un etablissement en particulier  
Route::get('/superadmin_detaileleve/{id}', 'SuperAdminAffController@detailmatiere')->name('vue_superadmin_detailmatiere');
// Pour afficher l'interface de mise à jour d'un etablissement 
Route::get('/superadmin_updateeleveaff/{id}', 'SuperAdminAffController@updatematiereaff')->name('vue_superadmin_updatematiereaff');
// Pour mettre à jour les données d'un etablissement
Route::post('/superadmin_updateelevee/{id}', 'SuperAdminAffController@updatematiere')->name('vue_superadmin_updatematiere');
