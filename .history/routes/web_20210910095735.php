...
// Pour afficher la liste des etablissements 
Route::get('/superadmin_all', 'SuperAdminAffController@all')->name('vue_superadmin_all');
// Pour afficher la vue d'ajout d'un etablissement 
Route::get('/superadmin_addaff', 'SuperAdminAffController@addaff')->name('vue_superadmin_addaff');
// Pour ajouter un etablissement
Route::post('/superadmin_add', 'SuperAdminAffController@add')->name('vue_superadmin_add');
// Pour afficher le detail sur un etablissement en particulier  
Route::get('/superadmin_detail/{id}', 'SuperAdminAffController@detail')->name('vue_superadmin_detail');
// Pour afficher l'interface de mise à jour d'un etablissement 
Route::get('/superadmin_updateaff/{id}', 'SuperAdminAffController@updateaff')->name('vue_superadmin_updateaff');
// Pour mettre à jour les données d'un etablissement
Route::post('/superadmin_update/{id}', 'SuperAdminAffController@update')->name('vue_superadmin_update');
