...
// Pour afficher la liste des etablissements 
Route::get('/superadmin_alleleve', 'SuperAdminAffController@alleleve')->name('vue_superadmin_allmatiere');
// Pour afficher la vue d'ajout d'un etablissement 
Route::get('/superadmin_addeleveaff', 'SuperAdminAffController@addeleveaff')->name('vue_superadmin_addmatiereaff');
// Pour ajouter un etablissement
Route::post('/superadmin_addeleve', 'SuperAdminAffController@addeleve')->name('vue_superadmin_addmatiere');
// Pour afficher le detail sur un etablissement en particulier  
Route::get('/superadmin_detaileleve/{id}', 'SuperAdminAffController@detaileleve')->name('vue_superadmin_detailmatiere');
// Pour afficher l'interface de mise à jour d'un etablissement 
Route::get('/superadmin_updateeleveaff/{id}', 'SuperAdminAffController@updateeleveaff')->name('vue_superadmin_updatematiereaff');
// Pour mettre à jour les données d'un etablissement
Route::post('/superadmin_updateeleve/{id}', 'SuperAdminAffController@updateelevee')->name('vue_superadmin_updatematiere');
