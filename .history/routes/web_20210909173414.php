...
Route::get('/superadmin_updateetablissementaff', 'SuperAdminAffController@updateetablissementaff')->name('vue_superadmin_updateetablissementaff');
// Pour mettre à jour les données d'un etablissement
Route::get('/superadmin_updateetablissement/{id}', 'SuperAdminAffController@updateetablissement')->name('vue_superadmin_updateetablissement');
