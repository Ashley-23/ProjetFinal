...
Route::get('/superadmin_updateclasseaff/{id}', 'SuperAdminAffController@updateclasseaff')->name('vue_superadmin_updateclasseaff');
// Pour mettre à jour les données d'un etablissement
Route::post('/superadmin_updateclasse/{id}', 'SuperAdminAffController@updateclasse')->name('vue_superadmin_updateclasse');', 'SuperAdminAffController@all
//                                                                  CLASSE
...
Route::get('/superadmin_updateclasseaff/{id}', 'SuperAdminAffController@updateclasseaff')->name('vue_superadmin_updateclasseaff');
// Pour mettre à jour les données d'un etablissement
Route::post('/superadmin_updateclasse/{id}', 'SuperAdminAffController@updateclasse')->name('vue_superadmin_updateclasse');')->name('vue_superadmin_all
//                                                                  CLASSE
...
Route::get('/superadmin_updateclasseaff/{id}', 'SuperAdminAffController@updateclasseaff')->name('vue_superadmin_updateclasseaff');
// Pour mettre à jour les données d'un etablissement
Route::post('/superadmin_updateclasse/{id}', 'SuperAdminAffController@updateclasse')->name('vue_superadmin_updateclasse');aff', 'SuperAdminAffController@add
//                                                                  CLASSE
...
Route::get('/superadmin_updateclasseaff/{id}', 'SuperAdminAffController@updateclasseaff')->name('vue_superadmin_updateclasseaff');
// Pour mettre à jour les données d'un etablissement
Route::post('/superadmin_updateclasse/{id}', 'SuperAdminAffController@updateclasse')->name('vue_superadmin_updateclasse');aff')->name('vue_superadmin_add
//                                                                  CLASSE
...
Route::get('/superadmin_updateclasseaff/{id}', 'SuperAdminAffController@updateclasseaff')->name('vue_superadmin_updateclasseaff');
// Pour mettre à jour les données d'un etablissement
Route::post('/superadmin_updateclasse/{id}', 'SuperAdminAffController@updateclasse')->name('vue_superadmin_updateclasse');aff');
// Pour ajouter un etablissement
Route::post('/superadmin_add
//                                                                  CLASSE
...
Route::get('/superadmin_updateclasseaff/{id}', 'SuperAdminAffController@updateclasseaff')->name('vue_superadmin_updateclasseaff');
// Pour mettre à jour les données d'un etablissement
Route::post('/superadmin_updateclasse/{id}', 'SuperAdminAffController@updateclasse')->name('vue_superadmin_updateclasse');', 'SuperAdminAffController@add
//                                                                  CLASSE
...
Route::get('/superadmin_updateclasseaff/{id}', 'SuperAdminAffController@updateclasseaff')->name('vue_superadmin_updateclasseaff');
// Pour mettre à jour les données d'un etablissement
Route::post('/superadmin_updateclasse/{id}', 'SuperAdminAffController@updateclasse')->name('vue_superadmin_updateclasse');')->name('vue_superadmin_add
//                                                                  CLASSE
...
Route::get('/superadmin_updateclasseaff/{id}', 'SuperAdminAffController@updateclasseaff')->name('vue_superadmin_updateclasseaff');
// Pour mettre à jour les données d'un etablissement
Route::post('/superadmin_updateclasse/{id}', 'SuperAdminAffController@updateclasse')->name('vue_superadmin_updateclasse');/{id}', 'SuperAdminAffController@detail
//                                                                  CLASSE
...
Route::get('/superadmin_updateclasseaff/{id}', 'SuperAdminAffController@updateclasseaff')->name('vue_superadmin_updateclasseaff');
// Pour mettre à jour les données d'un etablissement
Route::post('/superadmin_updateclasse/{id}', 'SuperAdminAffController@updateclasse')->name('vue_superadmin_updateclasse');')->name('vue_superadmin_detail
//                                                                  CLASSE
...
Route::get('/superadmin_updateclasseaff/{id}', 'SuperAdminAffController@updateclasseaff')->name('vue_superadmin_updateclasseaff');
// Pour mettre à jour les données d'un etablissement
Route::post('/superadmin_updateclasse/{id}', 'SuperAdminAffController@updateclasse')->name('vue_superadmin_updateclasse');aff/{id}', 'SuperAdminAffController@update
//                                                                  CLASSE
...
Route::get('/superadmin_updateclasseaff/{id}', 'SuperAdminAffController@updateclasseaff')->name('vue_superadmin_updateclasseaff');
// Pour mettre à jour les données d'un etablissement
Route::post('/superadmin_updateclasse/{id}', 'SuperAdminAffController@updateclasse')->name('vue_superadmin_updateclasse');aff')->name('vue_superadmin_update
//                                                                  CLASSE
...
Route::get('/superadmin_updateclasseaff/{id}', 'SuperAdminAffController@updateclasseaff')->name('vue_superadmin_updateclasseaff');
// Pour mettre à jour les données d'un etablissement
Route::post('/superadmin_updateclasse/{id}', 'SuperAdminAffController@updateclasse')->name('vue_superadmin_updateclasse');/{id}', 'SuperAdminAffController@update
//                                                                  CLASSE
...
Route::get('/superadmin_updateclasseaff/{id}', 'SuperAdminAffController@updateclasseaff')->name('vue_superadmin_updateclasseaff');
// Pour mettre à jour les données d'un etablissement
Route::post('/superadmin_updateclasse/{id}', 'SuperAdminAffController@updateclasse')->name('vue_superadmin_updateclasse');')->name('vue_superadmin_update
//                                                                  CLASSE
