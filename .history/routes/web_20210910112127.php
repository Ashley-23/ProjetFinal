...
// Pour afficher la liste des etablissements 
Route::get('/superadmin_allm', 'SuperAdminAffController@allm')->name('vue_superadmin_allm');
// Pour afficher la vue d'ajout d'un etablissement 
Route::get('/superadmin_addmaff', 'SuperAdminAffController@addmaff')->name('vue_superadmin_addmaff');
// Pour ajouter un etablissement
Route::post('/superadmin_addm', 'SuperAdminAffController@addm')->name('vue_superadmin_addm');
// Pour afficher le detail sur un etablissement en particulier  
Route::get('/superadmin_detailm/{id}', 'SuperAdminAffController@detailm')->name('vue_superadmin_detailm');
// Pour afficher l'interface de mise à jour d'un etablissement 
Route::get('/superadmin_updatemaff/{id}', 'SuperAdminAffController@updatemaff')->name('vue_superadmin_updatemaff');
// Pour mettre à jour les données d'un etablissement
Route::post('/superadmin_updatem/{id}', 'SuperAdminAffController@updatem')->name('vue_superadmin_updatem');
