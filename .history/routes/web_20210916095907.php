...
Route::get('/superadmin_listeeleve/listeeleve/{idclasse}/{idmatiere}', 'SuperAdminAffController@listeeleve')->name('vue_superadmin_listeeleve');
...
Route::post('/superadmin_addnote/{id}', 'SuperAdminAffController@listeeleve')->name('vue_superadmin_addnote');
