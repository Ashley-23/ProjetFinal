...
@section('content')
                ...
                <nav id="nav">
                    <ul class="links">
                        ...
                        <li class="active" ><a href="{{route('vue_siteinscription')}}">Inscription</a></li>
                    </ul>
                    <ul>
                        @if (Route::has('login'))
                    ...
                    <div id="main">
                        <form action="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="sign-up">Vous avez déjà un compte ? <a href="{{route('vue_Siteconnexion')}}">Connectez-vous</a> </div>
                            </div>
