                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu sub-group-active">
                                <li class="nav-item">
                                    <a href="{{route('vue_admin_allparent')}}" class="nav-link menu-active"><i class="fas fa-angle-right"></i>Tous les 
                                        Parents</a>
                                </li>
                                <li class="nav-item">
