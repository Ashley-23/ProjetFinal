	...
	<body class="is-preload">
		...
		<!-- Wrapper -->
			<div id="wrapper" class="fade-in">
				...
				<!-- Header -->
					<header id="header">
						<a href="{{asset('index.htm')}}l" class="logo">Massively</a>
					</header>

				<!-- Nav -->
					<nav id="nav">
						<ul class="links">
							<li class="active"><a href="{{asset('index.html')}}">This is Massively</a></li>
							<li><a href="{{asset('generic.html')}}">Generic Page</a></li>
							<li><a href="{{asset('elements.html')}}">Elements Reference</a></li>
						</ul>
						<ul class="icons">
